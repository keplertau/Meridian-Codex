---
title: "Commitment Implementation Notes"
...
*Commitment Implementation Notes v0.1. Companion to the [Meridian AI Standard](/ai-standard/the-meridian-standard) v4.1.1 and the [Control-Decay Probe Set v0.1](/ai-standard/probes). Cross-references the [Reference Implementation](/ai-standard/reference-implementation) page (MERIDIAN.md as the Standard's worked example). Validation gates pending: usability and empirical, shared with the Probe Set. Both clear before v0.1 stable.*
