...
*Probes Implementation Notes v0.1. Companion to the [Meridian AI Standard](/ai-standard/meridian-ai-standard) v4.1.1 and the [Control-Decay Probe Set v0.1](/ai-standard/probes). Cross-references the [MERIDIAN.md page](/ai-standard/meridian-md) (the Standard's operational document). Validation gates pending: usability and empirical, shared with the Probe Set. Both clear before v0.1 stable.*
