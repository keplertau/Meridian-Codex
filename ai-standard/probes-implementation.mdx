...
This is v0.1, stable as of 2026-04-29. Seven notes. The two validation gates the Probe Set carries (usability and empirical) cleared on the same day; the Implementation Notes share that release arc and mark stable alongside the Probe Set. The usability gate cleared at the AI-evaluator bar, the standing usability bar across instrument validation gates during the active building phase. The Meridian Council, on activation (latest 2027-08-27 per the governance hybrid trigger), can revisit the standard.
