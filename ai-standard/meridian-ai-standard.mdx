...
*Implementation: The organization's public declaration includes an honest assessment of how its own institutional practices align with the commitments it has adopted for its AI systems. Gaps between organizational practice and system commitments are acknowledged as areas for development rather than concealed as irrelevant. The [AI Standard Audit](/ai-standard/audit) makes the comparison operational: its Reciprocity Reading (Layer III) reads where institutional practice and model commitments cohere or diverge.*
...
**Reciprocal.** The Standard asks organizations to hold themselves to the same principles they implement in their systems. Adoption that creates an asymmetry between institutional practice and AI behavior has not understood the Standard's foundation. The [AI Standard Audit](/ai-standard/audit) makes the evaluation operational: its Reciprocity Reading reads where institutional practice and model commitments cohere or diverge.
