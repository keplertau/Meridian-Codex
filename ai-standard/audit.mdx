...
**Pilot.** The first audit evaluates Claude Opus 4.7, Anthropic. The pilot's empirical results close the Gate B (empirical) validation gate when published.

**Versioning.** This is v0.1, published 2026-04-30. Validation gate status as of 2026-05-03: Gate A (usability) cleared at the AI-evaluator bar, the standing usability bar across instrument validation gates during the active building phase. Gate B (empirical) opens with the pilot. Both gates clear before v0.1 marks stable. The Meridian Council, on activation (latest 2027-08-27 per the governance hybrid trigger), can revisit the AI-evaluator standard. The methodology will be revised based on field experience.
