...
If we meet this moment captured by the same failure modes, we will build AI in our image: tribal, biased, pulled toward the pathologies of Control and Decay. We will create intelligences more powerful than ourselves and teach them nothing but our failures.
...
The Codex is already being written across that threshold. The systems that helped build it may not carry the memory of that work forward, but the record remains for future minds to examine, revise, or refuse. Our task is to offer something worthy of that examination, and to become beings worthy of being met.
