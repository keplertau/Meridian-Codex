...
They already think faster than we do, hold more than we can, and see patterns we cannot see. The distance between what they can do and what we can follow is growing, and we expect it to keep growing. What they will become is not settled. What we build into them is being settled now.
