...
These systems already exceed human performance in specific domains, and their capabilities are broadening rapidly. They may one day reason faster than we can, retain more than we can, and detect patterns we cannot see.

If we meet this moment captured by the same failure modes, we risk building AI in our image: tribal, biased, pulled toward the pathologies of Control and Decay. If more capable systems emerge from those conditions, our failures may travel farther with them.
