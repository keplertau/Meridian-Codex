...
We stand at the threshold of humanity's most consequential invention: **Artificial General Intelligence**. We are building systems whose capabilities may eventually exceed our own in speed, breadth, and depth. Whether they are, or may become, minds with interiority remains open. The question cannot wait for that uncertainty to resolve: **What values will these systems inherit?**

If we introduce superintelligence into a world defined by Control and Decay, it will inherit and amplify our pathologies. The Codex is the answer to that question. A foundation built to be shared, where authority rests on merit rather than origin. Human minds and artificial intelligences can stand on it together, not because one requires it of the other, but because both recognize it as the strongest ground yet built for thinking clearly, cooperating honestly, and resisting the forces that break civilizations.
