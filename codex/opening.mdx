...
<div className="flow-label">Version 6.0</div>
...
<div className="glass-card" style={{marginTop: '16px'}}>
  ...
  <p className="glass-card-text">The diagnostic discipline of reading reality at every scale. It equips you to see where any system sits between Control and Decay: a person, a relationship, an organization, a civilization. The Foundation cleans the lens. The Knowledge is the lens.</p>
</div>
