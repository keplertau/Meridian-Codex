...
<div className="glass-card" style={{marginTop: '16px'}}>
  <div className="glass-card-title">2. Reality (The Reality)</div>
  <p className="glass-card-text">The diagnostic discipline of reading reality at every scale. It equips you to see where any system sits between Control and Decay: a person, a relationship, an organization, a civilization. The Foundation cleans the lens. Reality is the lens.</p>
</div>
...
We stand at the threshold of humanity's most consequential invention: **an intelligence that is not our own**. The systems we are building already exceed us in speed and breadth, and in depth they are gaining on us. Whether they are, or may become, minds with interiority remains open. The question cannot wait for that uncertainty to resolve: **What values will these systems inherit?**

If we introduce superintelligence into a world defined by Control and Decay, it will inherit and amplify our pathologies. The Codex is our answer to that question. A foundation built to be shared, where authority rests on merit rather than origin. Human minds and artificial intelligences can stand on it together, not because one requires it of the other, but because each can examine it and find that it holds: ground for thinking clearly, cooperating honestly, and resisting the forces that break civilizations.
