...
The framework is not the map. It is the commitment to follow the map, to redraw the map when the territory changes, and to hand the map to anyone willing to learn. It is not a set of conclusions. It is a set of disciplines that generate conclusions, test them, and revise them.
