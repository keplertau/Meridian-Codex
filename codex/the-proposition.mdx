...
description: >-
  ...
  point.
aiSummary: >-
  The Codex is not a manifesto, religion, or political platform. It is a
  framework for humans and AI, built on three disciplines: honest
  self-examination (Foundation), accurate world-modelling (Knowledge), and
  genuine cooperation (Bond). What it demands of you, and why drift toward
  Control or Decay is the default if nothing changes.
banner:
  state: removed
  enabled: false
  removed: true
