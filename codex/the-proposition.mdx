...
It is a living framework, proposed as a shared foundation for anyone committed to resisting the forces that have broken complex societies throughout history.
...
The Codex proposes that the Meridian Range can be held. That the pattern, the oscillation between Control and Decay that runs through the failures of complex civilizations, is not a law of physics. It is a pattern of behavior. And patterns of behavior can be interrupted by people disciplined enough to see them operating and committed enough to resist.
