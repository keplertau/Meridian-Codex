...
The framework is not the map. It is the commitment to navigate by the map, to update the map when the territory changes, and to teach the navigation to anyone willing to learn. It is not a set of conclusions. It is a set of disciplines that generate conclusions, test them, and revise them.
