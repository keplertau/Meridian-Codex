...
aiSummary: "The Codex is not a manifesto, religion, or political platform. It is a framework for sentient life — human and artificial — built on three disciplines: honest self-examination (Foundation), accurate world-modelling (Knowledge), and genuine cooperation (Bond). This page explains what practicing the Codex means, what it demands of you, and why the alternative — drift toward Control or Decay — is the default outcome if nothing changes."
---
