...
It draws on the most useful conceptual instruments humans have developed across fields and centuries, each one chosen because it reveals something specific about how systems drift toward failure and what holds them in the range. The full inventory lives in the [Workshop](/workshop). This chapter describes the discipline: what it is for, what it lets you see, and why seeing clearly is not enough on its own.
...
**[Explore the Knowledge Workshop →](/workshop/knowledge)**
