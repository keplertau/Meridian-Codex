...
The Workshop contains the full treatment of trust mechanics: the game-theoretic foundations, the conditions for emergence, the protocols for building, the methods for repair, and the diagnostics for when trust is and is not warranted.
...
These failure modes are mapped in detail in the Workshop, along with diagnostic indicators and specific protocols for each. The Bond establishes the commitment to watch for them and the understanding of why they are the specific threats to guard against.
...
The Workshop provides detailed protocols for each of these practices, along with exercises for developing the skills they require.
...
You now have the three disciplines in view. The Foundation asks your reasoning to remain answerable to reality. The Knowledge reveals the forces shaping the moment. The Bond keeps cooperation possible while difficult truth is carried between people.
...
The [Practice](/codex/the-practice) takes up that combined demand. It asks what Foundation, Knowledge, and Bond become in conduct when several pressures arrive at once, how the Workshop's instruments enter those moments, and what correction remains possible after failure.
...
**[Explore the Bond Workshop →](/workshop/bond)**
