...
aiSummary: "The definitive reference for every term in the Codex. Covers the core concepts (Meridian Range, the Pattern, Control, Decay), the drivers that fuel civilizational drift, the disciplines and their tools, and the governance structures that keep the framework evolving. Start here when a term needs precision."
---
