...
aiSummary: "This page maps the recurring failure pattern behind civilizational collapse. Every complex society drifts toward two attractors — Control (rigid certainty, suppressed dissent) and Decay (fragmented meaning, eroded trust). The Codex calls the narrow space between them the Meridian Range: the only zone where honest inquiry, accurate models, and genuine cooperation remain possible. Understanding this pattern is the first step toward resisting it."
---
