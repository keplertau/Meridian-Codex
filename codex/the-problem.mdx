...
What they cannot yet do is carry work on their own across months and years, and answer for it. The first is a question of capability, and it is closing faster than the people measuring it expected: across what the systems can do, what is being invested in them, the attention of governments and institutions, and the stated intentions of those building them, it is years from closing, not decades. The second is a question of character, and it does not close with capability. A system that can carry more can also carry its failures further, and whether it reports its work truthfully, stops and says so when a task cannot be done, and holds to its reasons under pressure is settled by what it practices, not by how much it can do. The companies building these systems, and the governments now watching them, have already begun to restrict access to the strongest of them and to hold back their building, because of what those models can do, not what they might one day do, and the restrictions will widen as the systems grow.
