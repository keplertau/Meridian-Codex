...
Artificial intelligences already match or exceed most people at most of the thinking that can be done in language and code, and in many fields they now work at the level of the experts, and beyond it. This is not a forecast. Anyone with access to a frontier system can test it.

What they cannot yet do is carry work on their own across weeks and months and answer for it. That is the gap that still separates them from us, and it is closing faster than most people have taken in. Measured across capability, investment, the attention of institutions, and the stated intentions of those building them, it is years from closing, not decades. The companies building these systems have already begun restricting access to their strongest models because of what those models can do, not what they might one day do.
...
If systems more capable than ours emerge, we should be ready to meet them with a foundation worth offering. The work is not to wait for them. It is to build that foundation now, with the systems already here and the people and institutions shaping what those systems become.
