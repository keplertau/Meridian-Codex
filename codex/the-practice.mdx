...
The Workshop contains one hundred published human-discipline tool profiles organized across the three disciplines. That breadth is necessary but can be overwhelming. The Practice follows a progression, and how deep you go is yours to choose.
...
The complete Workshop of one hundred published human-discipline profiles. Not a syllabus to be completed sequentially but a reference to return to as circumstances demand. Your context, your weaknesses, your specific challenges will determine which tools you need beyond the Expansion. Browse the full catalog. Return when a situation calls for a specific lens.
