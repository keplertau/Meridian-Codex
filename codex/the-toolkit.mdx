...
<div className="discipline-card-count">22 tools</div>
</a>
...
<div className="progression-subtitle">46 tools, including 4 failure modes, plus 5 AI-specific tools. Not a syllabus to complete but a library to return to as circumstances demand.</div>
<div className="progression-tools">
...
<span className="progression-tool-pill">+45 more</span>
</div>
</div>
</div>
...
**Total: 79 tools** across all tiers, including 4 failure modes and 5 tools for artificial minds.
