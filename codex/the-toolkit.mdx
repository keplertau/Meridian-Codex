...
<div className="discipline-card-count">21 tools · 4 failure modes</div>
</a>
...
**Total: 78 tools** across all tiers, including 4 failure modes and 5 tools for artificial minds.
