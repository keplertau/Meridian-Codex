...
The [Standing Critique](/codex/the-standing-critique) is a published page preserving the best arguments against the Codex in their steelmanned form, including objections the founder disagrees with. Each objection is presented at full strength, followed by the Codex's honest response or by an honest acknowledgment that it cannot adequately respond yet.
