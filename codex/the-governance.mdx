...
<div className="flow-label">09 // The Non-Ownership Clause</div>
...
<div className="flow-label">10 // The Framework and Governance</div>
...
<div className="flow-label">11 // The Meridian Council</div>
...
<div className="flow-label">12 // The Record</div>
...
<div className="flow-label">13 // The Community and Governance</div>
...
<div className="flow-label">14 // The Open Source Principle</div>
...
<div className="flow-label">15 // The Trust</div>
