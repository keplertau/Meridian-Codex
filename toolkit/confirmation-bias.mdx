...
{/* VISUAL INTENT: Shows how two people with different prior beliefs interpret identical evidence differently, demonstrating the perceptual filtering mechanism of confirmation bias. */}
...
{/* VISUAL INTENT: Shows how confirmation bias filters evidence through three sequential stages (seeking, interpretation, memory), progressively reducing the diversity of evidence until only confirming evidence remains. Demonstrates that filtering is invisible from inside. */}
...
{/* Input dots: mixed confirmation and disconfirmation */}
...
{/* Dots after filter 1: fewer red ones */}
...
{/* Dots after filter 2: mostly blue */}
...
{/* Connecting line between filters showing the flow */}
