...
{/* VISUAL INTENT — Shows contrast between a weakened, disconnected network (straw man) on the left and a strong, fully connected network (steelman) on the right, with a transformation arrow between them. Illustrates how steelmanning rebuilds arguments in their strongest form. */}

{/* Background */}
<rect width="720" height="300" rx="12" fill="#0D0F12"/>

{/* Left side: Straw Man — weak, incomplete structure */}
<text x="140" y="35" textAnchor="middle" fill="#E87461" fontSize="14" fontWeight="700" opacity="0.8">Straw man</text>

{/* Weak nodes — larger but desaturated, with gaps */}
...
{/* One missing connection — very faint */}
...
{/* Center: Transformation arrow and label */}
...
{/* Full, connected network with symmetric structure */}
...
{/* VISUAL INTENT — Shows a four-stage spectrum of intellectual engagement with opposing views. Left side (caricature, politeness) represents weak forms of engagement. Right side (steelman, understanding) represents the disciplined work that leads to genuine epistemic integrity. The visual progression emphasizes that steelmanning is the bridge between performance and real understanding. */}
