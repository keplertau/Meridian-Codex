...
<div className="rounded-2xl overflow-hidden mt-10 mb-12">
  <img src="/toolkit/the-update-protocol-banner.jpg" alt="The Update Protocol — a geometric lattice mid-revision, old bonds dissolving as new ones form" style={{width: '100%', display: 'block'}} />
</div>
