...
aiSummary: "Scout Mindset is the core orientation of the Foundation discipline. Where Soldier Mindset treats beliefs as territory to defend, Scout Mindset treats them as maps to be updated. This deep-dive covers the cognitive science behind defensive reasoning, practical exercises for building the scout orientation, and the specific failure modes that pull you back toward motivated reasoning."
---
...
<div className="rounded-2xl overflow-hidden mt-10 mb-12">
  <img src="/toolkit/scout-mindset-banner.jpg" alt="Scout Mindset — directed beam versus open field of awareness" style={{width: '100%', display: 'block'}} />
</div>
...
<svg viewBox="0 0 700 175" fill="none" style={{width: '100%', maxWidth: '700px'}}>
{/* Left: Soldier Mindset */}
<text x="170" y="18" textAnchor="middle" fill="#e74c3c" fontSize="10" fontFamily="Plus Jakarta Sans" fontWeight="700" letterSpacing="0.1em" opacity="0.6">SOLDIER</text>

{/* Evidence enters */}
<circle cx="60" cy="65" r="4" fill="var(--mc-green)" opacity="0.5"/>
<text x="60" y="82" textAnchor="middle" fill="currentColor" fontSize="7" fontFamily="Plus Jakarta Sans" fontWeight="400" opacity="0.35">Supports</text>
<circle cx="60" cy="110" r="4" fill="#e74c3c" opacity="0.4"/>
<text x="60" y="127" textAnchor="middle" fill="currentColor" fontSize="7" fontFamily="Plus Jakarta Sans" fontWeight="400" opacity="0.35">Threatens</text>

{/* Sorting arrows */}
<line x1="75" y1="65" x2="120" y2="45" stroke="var(--mc-green)" strokeWidth="1" opacity="0.3"/>
<polygon points="120,45 114,47 116,53" fill="var(--mc-green)" opacity="0.3"/>
<line x1="75" y1="110" x2="120" y2="130" stroke="#e74c3c" strokeWidth="1" opacity="0.25"/>
<polygon points="120,130 114,124 116,130" fill="#e74c3c" opacity="0.25"/>

{/* Ammunition bin */}
<rect x="130" y="30" width="100" height="30" rx="5" fill="var(--mc-green)" fillOpacity="0.08" stroke="var(--mc-green)" strokeWidth="1" opacity="0.3"/>
<text x="180" y="49" textAnchor="middle" fill="var(--mc-green)" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="500" opacity="0.5">Ammunition</text>

{/* Threat bin — crossed out */}
<rect x="130" y="118" width="100" height="30" rx="5" fill="#e74c3c" fillOpacity="0.05" stroke="#e74c3c" strokeWidth="1" opacity="0.25"/>
<text x="180" y="137" textAnchor="middle" fill="#e74c3c" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="500" opacity="0.4">Dismissed</text>
<line x1="130" y1="118" x2="230" y2="148" stroke="#e74c3c" strokeWidth="0.8" opacity="0.2"/>

{/* Result: position defended */}
<text x="170" y="165" textAnchor="middle" fill="currentColor" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="400" fontStyle="italic" opacity="0.35">Position defended</text>

{/* Center divider */}
<line x1="350" y1="25" x2="350" y2="155" stroke="currentColor" strokeWidth="1" opacity="0.08"/>

{/* Right: Scout Mindset */}
<text x="530" y="18" textAnchor="middle" fill="var(--mc-green)" fontSize="10" fontFamily="Plus Jakarta Sans" fontWeight="700" letterSpacing="0.1em" opacity="0.8">SCOUT</text>

{/* Evidence enters */}
<circle cx="420" cy="65" r="4" fill="var(--mc-green)" opacity="0.5"/>
<text x="420" y="82" textAnchor="middle" fill="currentColor" fontSize="7" fontFamily="Plus Jakarta Sans" fontWeight="400" opacity="0.35">Supports</text>
<circle cx="420" cy="110" r="4" fill="#e74c3c" opacity="0.4"/>
<text x="420" y="127" textAnchor="middle" fill="currentColor" fontSize="7" fontFamily="Plus Jakarta Sans" fontWeight="400" opacity="0.35">Threatens</text>

{/* Both go to same place */}
<line x1="435" y1="65" x2="500" y2="80" stroke="var(--mc-green)" strokeWidth="1" opacity="0.3"/>
<polygon points="500,80 494,75 493,82" fill="var(--mc-green)" opacity="0.3"/>
<line x1="435" y1="110" x2="500" y2="92" stroke="var(--mc-green)" strokeWidth="1" opacity="0.3"/>
<polygon points="500,92 493,90 494,97" fill="var(--mc-green)" opacity="0.3"/>

{/* Accuracy processor */}
<rect x="510" y="70" width="120" height="32" rx="6" stroke="var(--mc-green)" strokeWidth="1.5" opacity="0.5"/>
<text x="570" y="85" textAnchor="middle" fill="var(--mc-green)" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="600" opacity="0.7">ACCURACY</text>
<text x="570" y="96" textAnchor="middle" fill="currentColor" fontSize="7" fontFamily="Plus Jakarta Sans" fontWeight="400" opacity="0.4">All evidence weighed equally</text>

{/* Result: map updated */}
<text x="530" y="165" textAnchor="middle" fill="currentColor" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="400" fontStyle="italic" opacity="0.35">Map updated</text>
</svg>
</div>
...
<div className="glass-card" style={{padding: '2rem 1.5rem', textAlign: 'center'}}>
<svg viewBox="0 0 700 110" fill="none" style={{width: '100%', maxWidth: '700px'}}>
{/* Left: Belief held by identity — fused, immovable */}
<text x="170" y="15" textAnchor="middle" fill="#e74c3c" fontSize="9" fontFamily="Plus Jakarta Sans" fontWeight="600" letterSpacing="0.05em" opacity="0.6">HELD BY IDENTITY</text>

{/* Person and belief fused together */}
<circle cx="140" cy="48" r="18" fill="#e74c3c" fillOpacity="0.08" stroke="#e74c3c" strokeWidth="1.5" opacity="0.3"/>
<text x="140" y="45" textAnchor="middle" fill="currentColor" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="500" opacity="0.5">You</text>
<circle cx="200" cy="48" r="18" fill="#e74c3c" fillOpacity="0.08" stroke="#e74c3c" strokeWidth="1.5" opacity="0.3"/>
<text x="200" y="45" textAnchor="middle" fill="currentColor" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="500" opacity="0.5">Belief</text>
{/* Overlap / fusion */}
<rect x="155" y="32" width="30" height="32" fill="#e74c3c" fillOpacity="0.06"/>
<text x="170" y="55" textAnchor="middle" fill="#e74c3c" fontSize="6" fontFamily="Plus Jakarta Sans" fontWeight="500" opacity="0.5">fused</text>

<text x="170" y="82" textAnchor="middle" fill="currentColor" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="400" opacity="0.35">Changing the belief</text>
<text x="170" y="93" textAnchor="middle" fill="currentColor" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="400" opacity="0.35">feels like losing yourself</text>

{/* Center divider */}
<line x1="350" y1="10" x2="350" y2="100" stroke="currentColor" strokeWidth="1" opacity="0.08"/>

{/* Right: Belief held by evidence — separate, movable */}
<text x="530" y="15" textAnchor="middle" fill="var(--mc-green)" fontSize="9" fontFamily="Plus Jakarta Sans" fontWeight="600" letterSpacing="0.05em" opacity="0.7">HELD BY EVIDENCE</text>

{/* Person and belief separate */}
<circle cx="480" cy="48" r="18" fill="var(--mc-green)" fillOpacity="0.05" stroke="var(--mc-green)" strokeWidth="1.5" opacity="0.4"/>
<text x="480" y="52" textAnchor="middle" fill="currentColor" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="500" opacity="0.5">You</text>

{/* Belief held at arm's length */}
<circle cx="580" cy="48" r="18" fill="var(--mc-green)" fillOpacity="0.05" stroke="var(--mc-green)" strokeWidth="1.5" opacity="0.4"/>
<text x="580" y="52" textAnchor="middle" fill="currentColor" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="500" opacity="0.5">Belief</text>

{/* Connection: evidence line, not identity fusion */}
<line x1="498" y1="48" x2="562" y2="48" stroke="var(--mc-green)" strokeWidth="1" opacity="0.3" strokeDasharray="4,3"/>
<text x="530" y="42" textAnchor="middle" fill="var(--mc-green)" fontSize="6" fontFamily="Plus Jakarta Sans" fontWeight="500" opacity="0.5">evidence</text>

<text x="530" y="82" textAnchor="middle" fill="currentColor" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="400" opacity="0.35">Changing the belief</text>
<text x="530" y="93" textAnchor="middle" fill="currentColor" fontSize="8" fontFamily="Plus Jakarta Sans" fontWeight="400" opacity="0.35">updates the map, not you</text>
</svg>
</div>
