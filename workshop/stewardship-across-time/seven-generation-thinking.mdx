...
**Why this tool is in the Workshop.** Stewardship Across Time needs a tool that admits the people missing because they have not arrived yet. Seven-Generation Thinking supplies that descendant horizon without becoming generic long-termism: it asks what present choices pass forward, what future freedom must remain, and what tradeoff follows now. Kaitiakitanga is the nearest sibling, but it grounds guardianship in entrusted relation and standing. Seven-Generation Thinking has the narrower job of giving absent descendants a claim inside present decisions.
