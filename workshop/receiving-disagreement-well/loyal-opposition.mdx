...
**Why this tool is in the Inheritance.** Loyal Opposition is here because receiving disagreement sometimes has to be built into the order before a particular conflict begins. Keeping Shared Signal Honest carries the person-side obligation to produce costly dissent; Sabotage Diagnostics tests whether opposition is being used in bad faith. This tool trains the receiving system: can someone oppose a leader, policy, or majority while remaining inside the shared frame? It belongs in Receiving Disagreement Well because dissent has to be recognized as service before the system can learn from it.
...
**Within the category.** [Productive Conflict](/inheritance/receiving-disagreement-well/productive-conflict) trains the live disagreement. Loyal Opposition gives that disagreement a recognized role before the live conflict begins. [Connection Before Correction](/inheritance/receiving-disagreement-well/connection-before-correction) is the interactional sequence that helps dissent be received without being converted into attack.

**Across the Inheritance.** [Preference Falsification](/inheritance/speaking-honestly-when-it-costs/preference-falsification) is what happens when opposition lacks standing and dissent stays private. Psychological Safety is the future Bond condition that makes interpersonal risk speakable. [Sabotage Diagnostics](/inheritance/cooperating-under-bad-faith/sabotage-diagnostics) is the necessary guardrail: not every opposition is loyal, and not every challenge is dissent in service of the shared order. [The Exclusion Problem](/inheritance/cooperating-under-bad-faith/exclusion-problem) begins where opposition has become sustained bad-faith exploitation.
