...
aiSummary: "Bond tool inside Receiving Disagreement Well. Productive Conflict turns disagreement toward better judgment while resisting domination and conflict avoidance. Practice: name the object, protect the person while testing the claim, search for the hinge, and pause before damage. Where good-faith disagreement persists and a shared decision cannot wait, connect to Action Situation Mapping, Polycentric Governance, Stewardship Across Time, Rules-in-Use, and Loyal Opposition: justify authority and burdens, represent absent parties, preserve objection and review. The Codex does not supply a universal allocation rule or guarantee an outcome without loss. Lineage: Follett, task and relationship conflict research, and constructive controversy."
discipline: bond
...
*Bond · Receiving Disagreement Well*
...
Good-faith disagreement can remain when a shared decision cannot wait and every available choice imposes a loss. Then the work is to establish who may decide, explain why the burdens fall where they do, hear those who bear them, and preserve a way to challenge and revise the decision. People can continue to cooperate while opposing the choice made.

[Action Situation Mapping](/inheritance/reading-whats-operating/action-situation-mapping) locates the decision and who can affect it. [Polycentric Governance](/inheritance/reading-whats-operating/polycentric-governance) asks which authority fits the scale of the problem. Describing who has power does not establish their right to use it. [Stewardship Across Time](/inheritance/stewardship-across-time) brings absent parties into consideration, including the question of who can speak for them. [Rules-in-Use](/inheritance/reading-whats-operating/rules-in-use) tests whether protections constrain those with power; [Loyal Opposition](/inheritance/receiving-disagreement-well/loyal-opposition) preserves dissent within a shared order. Where that order itself is disputed, its authority must also be examined.

Two communities may understand a water shortage and still disagree about whose use should be reduced. The decision must state which needs it gives priority to and why, what alternatives were rejected, and what losses cannot be repaired. It must name who will review the allocation and what would cause it to change. Compliance is not consent, and a later review cannot undo every loss. The Codex disciplines the judgment without supplying a universal allocation rule.
...
**Why this tool is in the Inheritance.** Productive Conflict is here because this category needs a live-disagreement discipline, not only attitudes toward dissent. Double Crux and Steelmanning help a belief update against a stronger countercase; Repairing After Rupture begins after conflict has already damaged trust. This tool asks the Bond question in the middle of friction: is the disagreement making our judgment better, or is it producing dominance, harmony theater, or noise? It belongs in Receiving Disagreement Well because contradiction has to remain usable while people are still in the room with it.
...
**Within the category.** [Connection Before Correction](/inheritance/receiving-disagreement-well/connection-before-correction) is one micro-practice that keeps conflict productive: name what is valid before pressing what is wrong. [Loyal Opposition](/inheritance/receiving-disagreement-well/loyal-opposition) institutionalizes a productive-conflict role so dissent has standing before a particular conflict begins.

**Across the Inheritance.** [Double Crux](/inheritance/revising-beliefs-under-evidence/double-crux) supplies a hinge-finding method when the conflict is about beliefs or predictions. [Steelmanning](/inheritance/revising-beliefs-under-evidence/steelmanning) keeps the other position from being weakened before it is engaged. Repairing After Rupture is the future Bond category for conflicts that have already damaged trust and need restoration before the work can continue.
