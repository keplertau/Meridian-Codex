...
**Within the category.** [Bayesian Reasoning](/inheritance/calibrating-confidence-to-evidence/bayesian-reasoning) supplies the inference structure: prior, evidence, posterior. Calibration Training supplies the feedback discipline: did the confidence you stated actually match what happened? The Bayesian frame tells you how confidence should move. Calibration Training tells you whether your own use of confidence is trustworthy.

**Within the Foundation.** [Dunning-Kruger Effect](/inheritance/watching-your-own-reasoning/dunning-kruger-effect) shows why self-assessment without feedback is exposed. Calibration Training is one of its corrective practices. [Base Rate Neglect](/inheritance/watching-your-own-reasoning/base-rate-neglect) supplies a common source of miscalibration: case evidence feels more diagnostic than it is. [The Update Protocol](/inheritance/revising-beliefs-under-evidence/the-update-protocol) uses calibrated confidence as the scale on which revisions happen.
