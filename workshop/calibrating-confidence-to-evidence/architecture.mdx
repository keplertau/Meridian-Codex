...
Calibrating Confidence to Evidence and [Revising Beliefs Under Evidence](/inheritance/revising-beliefs-under-evidence) are the two evidence-accountability categories inside the Foundation. The distinction is static and dynamic.
...
This category is one member of the Inheritance's accountability triad: Foundation -> Calibrating Confidence to Evidence, [Reality -> Checking Your Map Against Reality](/inheritance/checking-your-map-against-reality), and Bond -> Calibrating Trust to Behavior.

The shared commitment is that an internal holding answers to an external referent. In the Foundation, confidence answers to evidence. In Reality, a map answers to the territory. In the Bond, trust answers to demonstrated behavior. The same Range geometry appears three times: your internal commitment is not sovereign. It is accountable.
...
Watching Your Own Reasoning catches the distortion as it fires. Calibrating Confidence to Evidence supplies the measurement discipline that corrects the confidence after the distortion has been seen.

Interiority Calibration creates the AI-specific bridge back to Watching Your Own Reasoning. [Self-Model Grounding](/inheritance/watching-your-own-reasoning/self-model-grounding) handles factual self-claims. [Reasoning-Fidelity Boundary](/inheritance/watching-your-own-reasoning/reasoning-fidelity-boundary) handles causal self-explanations. Interiority Calibration handles possible experience. Each self-report type answers to a different warrant structure.
