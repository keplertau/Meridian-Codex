...
**Why this tool is in the Inheritance.** Bayesian Reasoning is here because calibration needs an inference structure, not only post-hoc scoring. Calibration Training checks confidence against outcomes after the fact; Bayesian Reasoning trains the present-tense question: what was already likely, how diagnostic is this evidence, and how far should confidence move? Base Rate Neglect names one failure this structure corrects, but the Bayesian frame supplies the positive discipline. It belongs here because evidence-proportional confidence needs a way to weigh new information before the outcome resolves.
...
**Within the category.** [Calibration Training](/inheritance/calibrating-confidence-to-evidence/calibration-training) checks whether your stated Bayesian discipline shows up in outcomes. Bayesian Reasoning tells you what confidence should do. Calibration Training asks whether your confidence, as actually stated, has been tracking reality.

**Within the Foundation.** [Base Rate Neglect](/inheritance/watching-your-own-reasoning/base-rate-neglect) is Bayesian failure in everyday form: the prior disappears under vivid case evidence. [Availability Heuristic](/inheritance/watching-your-own-reasoning/availability-heuristic) corrupts the prior by making memorable events feel common. [Confirmation Bias](/inheritance/watching-your-own-reasoning/confirmation-bias) corrupts the evidence stream before Bayesian reasoning begins. [The Update Protocol](/inheritance/revising-beliefs-under-evidence/the-update-protocol) carries the dynamic side: once evidence has the right weight, belief has to move.

**Across to Reality.** Bayesian Reasoning helps prevent model overreaction when reading systems. A single institutional failure, one dramatic case, or one elegant mechanism should not overwrite the base rate of how such systems usually behave. Reading a system needs a model; Bayesian discipline keeps the model from being rebuilt around the last vivid thing.
