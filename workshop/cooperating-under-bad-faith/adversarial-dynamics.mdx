...
description: "The lens that makes predation, capture, and exploitation legible inside cooperative systems — identifying strategic use and asymmetric accountability without turning every adverse outcome into evidence of bad faith."
aiSummary: "Adversarial Dynamics is the Bond tool that functions as the lens for the Cooperating Under Bad Faith category. Its core insight: some failures are engineered, not structural — an actor learns the cooperative system's language, accumulates authority through visible alignment, and spends it on something the framework was never designed to sanction. The mechanism (engineered versus drift failure; the threshold of strategic use and asymmetric accountability; what the lens reveals — trust mining, the cooperative vulnerability, the exclusion problem, sabotage diagnostics, each a contributing tool in this category with its own profile), the practice (Reciprocation Test, Pattern Assessment, Structural Check), the lineage (Axelrod's game theory, Olson and Ostrom's institutional economics, Stigler on regulatory capture, Popper and Rawls on the limits of tolerance), and cross-references inside the category and across the Inheritance."
discipline: bond
...
Structural drift is the nearest boundary, not a second adversary inside this tool. Incentives can reward defection and produce exploitative outcomes through people who never adopted an exploitative strategy. Those conditions require systems diagnosis and repair. They enter this lens only when a participant begins to use the resulting asymmetry strategically or invokes cooperative norms without accepting reciprocal constraint.
...
A regulatory agency was created to oversee a powerful industry. Over two decades, senior staff rotated through industry positions and back into the agency. Each individual career move was defensible, several admirable on their own terms. The aggregate was capture: the agency stopped producing decisions that constrained the industry in meaningful ways. On the facts given, no adversarial threshold has been crossed. Career incentives, informational asymmetry, and repeated interaction explain the outcome without strategic use by a participant. The case belongs first to systems diagnosis. It would enter this lens only if an actor began knowingly using those conditions to extract value or invoke the institution's rules asymmetrically.
...
**Why this tool is in the Inheritance.** Adversarial Dynamics is here because Cooperating Under Bad Faith needs a lens before it needs individual mechanisms. Diagnosing Cooperation reads whether cooperative conditions are present; Calibrating Trust to Behavior governs ordinary trust based on conduct over time. This tool asks a different question: what changes when the cooperative frame itself is being studied, gamed, or weaponized? It belongs here because the sibling tools are not isolated warnings; they are mechanisms inside adversarial cooperation: trust mining, cooperative vulnerability, sabotage diagnostics, and exclusion.
...
The political science literature on entryism and regulatory capture documents two neighboring routes to capture. Entryism supplies strategic cases in which actors enter an institution in order to redirect it. George Stigler's work (*The Theory of Economic Regulation*, 1971) shows that regulatory bodies can also come to serve the industries they regulate through career incentives, informational asymmetry, and repeated interaction. The second route is the boundary: capture can exist without bad-faith strategy, so capture alone does not satisfy this tool.
...
The wider social-psychology and institutional literature is a boundary warning rather than evidence of a second adversary. Structures can shape behavior and produce harmful or extractive outcomes without bad-faith strategy. Adversarial Dynamics should not convert that general fact into motive attribution. Its narrower job begins when strategic use, patterned reciprocation failure, or asymmetric accountability is visible in conduct.
...
**Within the category.** Adversarial Dynamics is the lens; the other four contributing tools in Cooperating Under Bad Faith are the specific mechanisms it brings into focus. [Trust Mining](/inheritance/cooperating-under-bad-faith/trust-mining) is the two-phase accumulation-then-extraction pattern, including institutional capture as its scaled form. [The Cooperative Vulnerability](/inheritance/cooperating-under-bad-faith/cooperative-vulnerability) is the framework's own vocabulary turned into an attack surface. [Sabotage Diagnostics](/inheritance/cooperating-under-bad-faith/sabotage-diagnostics) is the discipline of telling genuine dissent from strategic sabotage across a pattern of behavioral signatures. [The Exclusion Problem](/inheritance/cooperating-under-bad-faith/exclusion-problem) is the conditions under which a participant has to be excluded from a particular cooperative setting for that setting to survive. Each has its own profile; this lens carries the compressed treatment that frames them as one architectural family.

**Across the Inheritance.** [Calibrating Trust to Behavior](/inheritance/calibrating-trust-to-behavior) is the Bond category Adversarial Dynamics most directly pressures — calibrated trust is the Bond's prescription, and trust mining is the strategy that games the calibration. [Receiving Disagreement Well](/inheritance/receiving-disagreement-well) carries the receiving-side function of Steelmanning, which Adversarial Dynamics shows can be weaponized when one party engages the strongest version of their own position while caricaturing yours. In the Foundation, [Steelmanning](/inheritance/revising-beliefs-under-evidence/steelmanning) itself is the clearest case of a cooperative practice that becomes an attack surface under bad faith — the lens reads the asymmetry that Steelmanning's own practice cannot detect from inside.
