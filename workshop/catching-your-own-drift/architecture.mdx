...
The drift-category function repeats across all three disciplines. Catching Your Own Drift — Foundation asks whether the mind is still answerable to evidence. Catching Your Own Drift — Knowledge asks whether the system is being read as it is. Catching Your Own Drift — Bond asks whether cooperation is mutual or captured. Each discipline needs a category that names how its own practice fails.
