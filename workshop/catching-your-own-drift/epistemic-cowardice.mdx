...
**Why this tool is in the Inheritance.** Epistemic Cowardice belongs here because Catching Your Own Drift — Foundation needs a name for under-holding while it is still a move, not yet a worldview. The nearest Reality neighbor is Paralysis, but the failure is different. Paralysis is the interpretive apparatus losing decision-structure under complexity. Cowardice is the person already seeing enough to state a bounded view and withholding it because the cost of being answerable feels too high. The repair runs through calibrated confidence, pressure steadiness, and speech that can be corrected.
...
**Within the category.** [Epistemic Arrogance](/inheritance/catching-your-own-drift/epistemic-arrogance) is the opposite operational failure: stating more than the evidence warrants. [The Decaying Mind](/inheritance/catching-your-own-drift/the-decaying-mind) is what Cowardice can become when avoidance of commitment hardens into a worldview.

**Within the Foundation.** [Calibrating Confidence to Evidence](/inheritance/calibrating-confidence-to-evidence) gives Cowardice its immediate corrective: state the confidence the evidence warrants. [Revising Beliefs Under Evidence](/inheritance/revising-beliefs-under-evidence) keeps the claim available to correction once stated. [Staying Steady Under Pressure](/inheritance/staying-steady-under-pressure) handles the body-cost that often produces the avoidance.
