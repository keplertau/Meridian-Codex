...
**Why this tool is in the Inheritance.** The Decaying Mind belongs here because Foundation drift can harden into a chronic refusal to let any claim become stable enough to guide life. The nearest Reality neighbor is Paralysis, but Paralysis is the sensemaking apparatus losing decision-structure under complexity. The Decaying Mind is the person-level stance that treats commitment itself as naive after injury, betrayal, or repeated disappointment. The tool keeps the repair in the Foundation: rebuild proportion, bounded trust, and provisional belief without returning to innocence.
...
**Within the category.** [Epistemic Cowardice](/inheritance/catching-your-own-drift/epistemic-cowardice) is the operational failure that can consolidate into this state. [The Controlled Mind](/inheritance/catching-your-own-drift/the-controlled-mind) is the opposite chronic failure: certainty hardened until correction cannot enter.

**Within the Foundation.** [Calibrating Confidence to Evidence](/inheritance/calibrating-confidence-to-evidence) is the main corrective: confidence should rise when evidence warrants it, not only fall when evidence is weak. [Bayesian Reasoning](/inheritance/calibrating-confidence-to-evidence/bayesian-reasoning) trains proportional movement from prior to evidence. [The Update Protocol](/inheritance/revising-beliefs-under-evidence/the-update-protocol) keeps provisional commitment answerable to future evidence. [Charitable Interpretation](/inheritance/holding-beliefs-without-identity/charitable-interpretation) interrupts the assumption that ambiguity is always hostile.
