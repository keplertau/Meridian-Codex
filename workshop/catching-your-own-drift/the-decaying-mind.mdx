...
**Why this tool is in the Workshop.** The Decaying Mind belongs here because Foundation drift can harden into a chronic refusal to let any claim become stable enough to guide life. The nearest Knowledge neighbor is Paralysis, but Paralysis is the sensemaking apparatus losing decision-structure under complexity. The Decaying Mind is the person-level stance that treats commitment itself as naive after injury, betrayal, or repeated disappointment. The tool keeps the repair in the Foundation: rebuild proportion, bounded trust, and provisional belief without returning to innocence.
