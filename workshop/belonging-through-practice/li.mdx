...
<div id="if-the-form-trains-the-practice-keep-it-if-it-protects-status-revise-it" className="flow-label">If the form trains the practice, keep it. If it protects status, revise it.</div>
...
A community cannot live on declarations. It needs forms that carry its commitments when mood, charisma, and private intention fail.
...
- [Ubuntu](/inheritance/belonging-through-practice/ubuntu)
- [Sangha](/inheritance/belonging-through-practice/sangha)
- [Rectification of Names](/inheritance/checking-your-map-against-reality/rectification-of-names)
- [Connection Before Correction](/inheritance/receiving-disagreement-well/connection-before-correction)
