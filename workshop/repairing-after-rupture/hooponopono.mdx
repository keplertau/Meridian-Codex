...
**Within the category.** [Trust Repair](/inheritance/repairing-after-rupture/trust-repair) is the closest Inheritance-native neighbor. Ho'oponopono brings a relational and cultural setting-right grammar to the same repair problem. [Common Knowledge Generation](/inheritance/repairing-after-rupture/common-knowledge-generation) matters because setting right often requires shared witnessing, not only private apology.
