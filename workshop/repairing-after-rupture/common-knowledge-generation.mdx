...
**Why this tool is in the Inheritance.** Common Knowledge Generation is here because repair can fail even when everyone privately thinks the issue was addressed. Report Fidelity asks whether the shared record is trustworthy, and Schelling Points reads tacit expectations that already coordinate people. This tool handles the missing visibility after rupture: who knows what happened, who knows what changed, and what future conduct can now be judged against. It belongs in Repairing After Rupture because repair terms have to become mutually visible before people can rely on them together.
...
**Within the category.** [Trust Repair](/inheritance/repairing-after-rupture/trust-repair) names what must be repaired. Common Knowledge Generation makes the repair visible enough to guide future behavior. [Indaba](/inheritance/repairing-after-rupture/indaba) and [Peacemaking Circles](/inheritance/repairing-after-rupture/peacemaking-circles) are process forms that can generate common knowledge through direct collective speech.

**Across the Inheritance.** [Schelling Points](/inheritance/reading-whats-operating/schelling-points) reads tacit coordination where common expectations already exist. Common Knowledge Generation deliberately builds shared expectations when tacit salience is not enough. [Report Fidelity](/inheritance/checking-your-map-against-reality/report-fidelity) tests the shared record so that it does not coordinate people around a false or distorted account.
