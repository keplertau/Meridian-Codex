...
The keeper has to protect speech, listening, and accountability. A badly held circle can deepen the breach it was meant to repair. The process looks gentle from the outside. Inside serious harm, it is demanding work.
...
**Within the category.** [Trust Repair](/inheritance/repairing-after-rupture/trust-repair) names the repair sequence the circle may hold. [Common Knowledge Generation](/inheritance/repairing-after-rupture/common-knowledge-generation) explains how witnessing lets people know what others have heard, accepted, and committed to.

**Across the Inheritance.** [Productive Conflict](/inheritance/receiving-disagreement-well/productive-conflict) is upstream when disagreement can still become better judgment before it becomes rupture. [The Exclusion Problem](/inheritance/cooperating-under-bad-faith/exclusion-problem) is downstream when repair has been attempted in full and failed against a bad-faith pattern. Belonging Through Practice will be the later Bond category that carries community membership as ongoing discipline.
