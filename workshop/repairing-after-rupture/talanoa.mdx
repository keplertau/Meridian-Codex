...
**Across the Inheritance.** [Two-Eyed Seeing](/inheritance/triangulating-across-disciplines/two-eyed-seeing) is Reality neighbor for source-lineage caution: do not turn another knowledge system into raw material for your own frame. [Productive Conflict](/inheritance/receiving-disagreement-well/productive-conflict) matters when the dialogue has to move from story into disagreement that improves judgment.
