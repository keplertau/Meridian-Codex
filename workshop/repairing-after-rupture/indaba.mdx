...
**Within the category.** [Common Knowledge Generation](/inheritance/repairing-after-rupture/common-knowledge-generation) explains why the return to shared terms matters. [Trust Repair](/inheritance/repairing-after-rupture/trust-repair) names the repair commitments that may have to be negotiated through an indaba-style process.
