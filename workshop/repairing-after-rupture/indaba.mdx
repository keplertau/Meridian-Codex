...
A multi-stakeholder institution has mishandled a public failure. Legal, operational, community, and leadership groups each hold part of the repair. Ordinary meetings keep routing the breach into silos. An indaba-style process brings the issue into one consultation field, then uses focused solution rounds for the parts that require smaller negotiation. The proposed solution must return to the wider group for inspection; repair fails if it disappears into closed rooms.

The climate-negotiation example is the modern institutional proof of travel. Durban and Paris used indaba language and process forms when nearly two hundred parties had to find acceptable text under extreme time pressure. The lesson for the Inheritance is not that every large negotiation should copy UN climate process. It is that collective impasse sometimes needs a consultation form that alternates direct shared speech with focused work on unresolved differences.
...
**Within the category.** [Common Knowledge Generation](/inheritance/repairing-after-rupture/common-knowledge-generation) explains how returning proposed terms to the group makes them available for shared action and accountability. [Trust Repair](/inheritance/repairing-after-rupture/trust-repair) names the repair commitments that may have to be negotiated through an indaba-style process.

**Across the Inheritance.** [Productive Conflict](/inheritance/receiving-disagreement-well/productive-conflict) is the live-disagreement neighbor. [Polycentric Governance](/inheritance/reading-whats-operating/polycentric-governance) and [Mechanism Design](/inheritance/reading-whats-operating/mechanism-design) are the Reality neighbors when the impasse involves multiple centers of authority or broken decision rules.
