...
**Across the Inheritance.** [Productive Conflict](/inheritance/receiving-disagreement-well/productive-conflict) is the live-disagreement neighbor. [Polycentric Governance](/inheritance/reading-whats-operating/polycentric-governance) and [Mechanism Design](/inheritance/reading-whats-operating/mechanism-design) are Reality neighbors when the impasse involves multiple centers of authority or broken decision rules.
