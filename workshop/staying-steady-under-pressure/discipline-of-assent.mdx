...
**Within the category.** [Affect Labeling](/inheritance/staying-steady-under-pressure/affect-labeling) names the pressure signal before it becomes a story. The Discipline of Assent tests the story before it becomes judgment or action. [Psychological Flexibility](/inheritance/holding-beliefs-without-identity/psychological-flexibility) cross-loads as the broader capacity to remain with difficult inner experience while choosing from truth and values.

**Within the Foundation.** [Noticing](/inheritance/watching-your-own-reasoning/noticing) catches the impression as it arises. The Discipline of Assent asks whether the impression should be endorsed. [Wise Attention](/inheritance/watching-your-own-reasoning/wise-attention) operates earlier, directing attention toward what is operative before impressions form around surface salience. [Revising Beliefs Under Evidence](/inheritance/revising-beliefs-under-evidence) depends on the same gap: evidence can move belief only if first impressions have not already decided what the evidence is allowed to mean.

**Across to Reality.** Many system readings fail because the first appearance of the system receives assent too quickly. A formal policy appears operative. A confident dashboard appears accurate. A loud crisis appears important. A calm institution appears stable. Reality tools test the system outwardly; the Discipline of Assent protects the inward moment before the apparent system is mistaken for the actual one.
