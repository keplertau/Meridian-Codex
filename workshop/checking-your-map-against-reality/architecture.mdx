...
aiSummary: "Architecture page for Reality -> Checking Your Map Against Reality. Range-vantage articulation: the discipline of keeping the model accountable to the reality it claims to track, catching the moment map and territory have diverged, and revising the model rather than denying the territory. The Range pulls: Control = holding to the model when reality contradicts it, with Ideology at category level and the chapter's named failure mode operating here most directly; Decay = refusing to commit to any model because every model is provisional, with Paralysis at category level. Contributing tools at v0.1: Signal vs Noise, Information Degradation, Report Fidelity, Rectification of Names, and the AI-specific Objective-Trace Audit and Memory Provenance profiles. Cross-references the three-discipline accountability triad: Calibrating Confidence to Evidence in Foundation, belief accountable to evidence; Checking Your Map Against Reality in Reality, model accountable to territory; Calibrating Trust to Behavior in Bond, trust accountable to behavior. Same commitment: something held internally must answer to an external referent rather than to identity, social signal, or inertia. Chapter relationship: the Reality chapter's failure-mode section carries Ideology as the map replacing the territory; the chapter names the failure but the corrective discipline, active checking of the map against the territory, is what this category operationalizes."
discipline: reality
...
Checking Your Map Against Reality is one of three categories the Inheritance holds together as the accountability triad. The other two are [Foundation → Calibrating Confidence to Evidence](/inheritance/calibrating-confidence-to-evidence) and [Bond → Calibrating Trust to Behavior](/inheritance/calibrating-trust-to-behavior). The three share a commitment: something you hold internally has to answer to something outside you.
