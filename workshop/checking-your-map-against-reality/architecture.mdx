...
The four tools divide the category by object. Signal vs Noise asks what should enter the map as map-correcting information. Information Degradation asks what happens as information travels from source toward decision. Report Fidelity asks whether a decision-bearing report still warrants its interpretation and use. Rectification of Names asks whether the terms that coordinate action still match the realities they name.
