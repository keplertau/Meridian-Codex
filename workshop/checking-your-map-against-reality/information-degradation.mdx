...
**Within the category.** [Signal vs Noise](/inheritance/checking-your-map-against-reality/signal-vs-noise) asks which observations should move the map. Information Degradation asks what happens after an observation begins to travel. [Report Fidelity](/inheritance/checking-your-map-against-reality/report-fidelity) asks whether a report still warrants the interpretation and use attached to it. [Rectification of Names](/inheritance/checking-your-map-against-reality/rectification-of-names) asks whether the names that travel with the information still fit the reality.

**Across the Inheritance.** [Chilling Effects](/inheritance/reading-whats-operating/chilling-effects) and future Bond tools such as Preference Falsification explain why some signal may never enter the chain. [Rules-in-Use](/inheritance/reading-whats-operating/rules-in-use) asks what rule actually governs the channel. [Legibility](/inheritance/reading-whats-operating/legibility) explains why institutions compress reality into forms they can see.
