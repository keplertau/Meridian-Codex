...
**Across the Inheritance.** [Chesterton's Fence](/inheritance/revising-beliefs-under-evidence/chestertons-fence) is the Foundation-side caution before removing inherited structures. Legibility helps explain the survival of an old practice that preserved local knowledge the administrative map cannot see.
