...
Charles Goodhart formulated the core idea in monetary-policy terms while analyzing the United Kingdom's experience with monetary aggregates: statistical regularities used for control tend to break down under control pressure. The problem was not a generic complaint about numbers. It was a warning about governing through observed relationships after policy pressure has made those relationships unstable.
