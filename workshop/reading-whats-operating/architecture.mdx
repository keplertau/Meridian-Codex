...
description: "The mechanism-first category of the Knowledge: identifying what is presently producing a system's behavior before checking, triangulating, or acting on the reading."
...
The overlap is part of the reading. Tragedy of the Commons is also a strategic and institutional problem. Legibility joins institutional form to measurement and power. Network Effects can reshape both temporal dynamics and strategic payoff. Promoting the routes to peer categories would require arbitrary ownership precisely where the Knowledge needs several instruments to remain in contact.
...
Long-horizon observational lineages are not admitted here by mention. They remain search territories for the source-inherited Workshop candidate protocol: kaitiakitanga, seven-generation thinking, and additional deep-time observational practices may strengthen the temporal-horizon dimension, but only after source-lineage review establishes their exact mechanism, placement, and translation rule.
