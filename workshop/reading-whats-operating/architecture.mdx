...
description: "The mechanism-first category of Reality: identifying what is presently producing a system's behavior before checking, triangulating, or acting on the reading."
aiSummary: "Architecture page for Reality → Reading What's Operating. The category's bounded job is mechanism-first diagnosis: identify the force, relation, rule, incentive, pressure, or process through time that is producing a system's behavior before testing a representation, combining lenses, choosing an intervention, or governing a response. Scale and temporal horizon remain two dimensions of that one job. The 25 tools are organized through five overlapping navigation routes rather than new peer categories: structure and change through scale and time; strategic fields; collective traps; institutional machinery; and measurement, visibility, and power. The routes overlap because real systems often need several readings at once. Leverage Points, Mechanism Design, Action Situation Mapping, and Polycentric Governance remain diagnostic here, with action and governance implications cross-referenced. Instrumental Power Tripwires remains an AI-specific reading of power accumulation inside a task envelope, not a permission policy. The Range pulls are a locked model that already knows what it will find and endless observation that never commits to a reading. The page also carries the observation-pair cross-reference with Foundation → Watching Your Own Reasoning and the category's relationship to the Reality chapter."
discipline: reality
...
The discipline of Reality is mapping the world. This category makes the first move: identify the mechanism presently producing a system's behavior. The mechanism may be a feedback loop, payoff, rule, condition, measurement pressure, power relation, or process through time. The system may be a person, group, institution, market, technology, ecology, civilization, or human-AI task field.

The category boundary is the first output. A tool belongs here when it first gives you an account of the force, relation, rule, incentive, pressure, or temporal process generating the pattern. Checking Your Map Against Reality asks whether the representation still warrants the claim built from it. Triangulating Across Disciplines asks how several lenses or knowledge systems should be used together. Acting on What You See asks what movement should follow. A tool does not belong here merely because it can be applied to a system.
...
Long-horizon observational lineages are not admitted here by mention. They remain search territories for the source-inherited Inheritance candidate protocol: kaitiakitanga, seven-generation thinking, and additional deep-time observational practices may strengthen the temporal-horizon dimension, but only after source-lineage review establishes their exact mechanism, placement, and translation rule.
