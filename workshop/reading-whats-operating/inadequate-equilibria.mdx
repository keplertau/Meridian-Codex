...
The Codex did not invent Inadequate Equilibria. It inherits the tool from Eliezer Yudkowsky's 2017 book *Inadequate Equilibria: Where and How Civilizations Get Stuck* and places it inside Reality as an applied institutional diagnostic.
...
**Within the category.** [Prisoner's Dilemma](/inheritance/reading-whats-operating/prisoners-dilemma) reads the minimal cooperation trap. Inadequate Equilibria reads the wider institutional condition where improvement is blocked by incentive, authority, and coordination patterns. [Moloch](/inheritance/reading-whats-operating/moloch) reads the competitive race that can generate inadequate systems. [Rules-in-Use](/inheritance/reading-whats-operating/rules-in-use) asks what formal or informal constraints actually govern the stuck state. [Leverage Points](/inheritance/reading-whats-operating/leverage-points) helps distinguish a true intervention point from a complaint about symptoms.

**Across the Inheritance.** Checking Your Map Against Reality tests inadequacy claims that are especially vulnerable to flattering error. If you think you see a civilizational failure, the map needs pressure. Foundation tools such as Base Rate Neglect, Dunning-Kruger Effect, and Bayesian Reasoning remain active in the background.
