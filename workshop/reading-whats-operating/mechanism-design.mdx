...
**Define the participants and private information.** Who knows what? Who wants what? Who can misrepresent, hide, delay, exaggerate, free-ride, or exit? Mechanism Design becomes useful where private incentives and private information shape participants' choices.
...
The field has many practical descendants: auction design, public-goods funding, regulation, matching markets, voting procedures, taxation, market design, platform rules, and organizational governance. The formal theory can become mathematically demanding quickly, but the Inheritance version uses the central discipline: read the rules as a game, then ask what behavior becomes rational under those rules.

The Codex's translation is placement with a warning. Mechanism Design is a powerful Reality tool, but it sits near the border with action. Reading the mechanism belongs here. Building or revising the mechanism begins to belong to Acting on What You See and to governance practice. Without that distinction, the tool can become a shortcut from diagnosis to intervention.
...
**Within the category.** [Rules-in-Use](/inheritance/reading-whats-operating/rules-in-use) reads the actual game already operating. Mechanism Design asks what game would produce the desired outcome. [Prisoner's Dilemma](/inheritance/reading-whats-operating/prisoners-dilemma) and [Tragedy of the Commons](/inheritance/reading-whats-operating/tragedy-of-the-commons) show incentive failures that often need mechanism repair. [Inadequate Equilibria](/inheritance/reading-whats-operating/inadequate-equilibria) reads when the system remains bad because no actor can fix it alone.

**Across the Inheritance.** [Leverage Points](/inheritance/reading-whats-operating/leverage-points) asks where a system is sensitive; Mechanism Design often shows why changing rules, information flows, or incentives can alter the outcome. Acting on What You See is the natural next category when the question becomes whether and how to intervene.
