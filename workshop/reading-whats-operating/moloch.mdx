...
The Codex did not invent Moloch. It inherits the modern tool primarily from Scott Alexander's 2014 essay "Meditations on Moloch" and translates it into Reality as a reading instrument for competitive coordination failure.
...
**Within the category.** [Prisoner's Dilemma](/inheritance/reading-whats-operating/prisoners-dilemma) reads the minimal defection trap. Moloch reads the larger race pattern that can form when many actors are pressured to defect against shared values. [Network Effects](/inheritance/reading-whats-operating/network-effects) explains why joining the race can become harder to refuse as more actors enter it. [Rules-in-Use](/inheritance/reading-whats-operating/rules-in-use) asks what rule actually governs restraint under pressure. [Tragedy of the Commons](/inheritance/reading-whats-operating/tragedy-of-the-commons) is the shared-resource form of the same family.

**Across the Inheritance.** Mechanism Design becomes relevant when the question shifts from reading the race to changing the game. Bond practices become relevant when actors need enough trust, common knowledge, and credible commitment to stop racing alone.
