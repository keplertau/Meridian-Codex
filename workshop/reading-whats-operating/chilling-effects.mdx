...
**Why this tool is in the Inheritance.** Chilling Effects belongs here because a system's visible record can hide the behavior fear prevented from appearing. It reads anticipated punishment, vague rules, surveillance, asymmetric enforcement, and social cost as operating pressures that suppress signal before sanction. Keeping Shared Signal Honest and other Bond tools ask how to restore and maintain honest signal. Legal doctrine supplies the lineage, but the Inheritance job is broader: diagnose missing dissent, inquiry, reporting, association, or repair before treating quiet as consent or health.
...
In this category, Chilling Effects treats missing behavior as evidence of operative pressure. It is a Reality tool before it is a Bond or governance question: first see that the signal has been suppressed, then ask what cooperative or institutional repair would make the signal possible again.
...
**Within the category.** [Rules-in-Use](/inheritance/reading-whats-operating/rules-in-use) asks what rule actually governs speech under pressure. [Legibility](/inheritance/reading-whats-operating/legibility) reads how visibility to authority changes behavior. [Goodhart's Law](/inheritance/reading-whats-operating/goodharts-law) can explain metric systems that chill truth-telling by attaching cost to visible bad news.

**Across the Inheritance.** Mechanism Design asks what incentives make silence rational. Preference Falsification and Keeping Shared Signal Honest are Bond-side companions: they move from reading suppressed signal to restoring the conditions under which people can say what they actually think.
