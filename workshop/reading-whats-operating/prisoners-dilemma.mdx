...
**Why this tool is in the Inheritance.** Prisoner's Dilemma belongs here because it gives Reading What's Operating its minimal cooperation-trap diagnostic: a situation can reward each actor for defecting even when mutual cooperation would leave everyone better off. The Bond teaches how cooperation is practiced, trusted, repaired, and protected. This tool reads the game before that relational work begins. It asks whether cooperation has been made too exposed by the payoff structure, and what conditions would make it safer than unilateral protection.
...
The Codex did not invent the Prisoner's Dilemma. It inherits the tool from game theory and places it inside Reality as a reading instrument for cooperation traps.
...
**Within the category.** [Feedback Loops](/inheritance/reading-whats-operating/feedback-loops) reads how defection can become self-reinforcing: one protective move produces the next. [Network Effects](/inheritance/reading-whats-operating/network-effects) reads how the spread of a cooperative or defecting norm changes payoffs as more actors join it. [Rules-in-Use](/inheritance/reading-whats-operating/rules-in-use) asks what rule actually governs behavior under pressure; Prisoner's Dilemma asks what the payoff structure makes each actor want to do alone. [Entropy](/inheritance/reading-whats-operating/entropy) explains why cooperative arrangements degrade if the conditions that maintain them stop being paid for.

**Across the Inheritance.** The Prisoner's Dilemma is one of Reality-side tools underneath Bond practice. Good Faith as Default, calibrated trust, repair, and productive conflict all become naive if the situation rewards unilateral defection and nothing in the system answers it. The Bond's practices still have to be learned and sustained, but they need a game that cooperation can survive inside.
