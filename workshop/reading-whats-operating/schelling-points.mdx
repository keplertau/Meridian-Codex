...
**Within the category.** [Prisoner's Dilemma](/inheritance/reading-whats-operating/prisoners-dilemma) reads the temptation to defect; Schelling Points reads how actors may coordinate when the problem is choosing together, not resisting temptation. [Network Effects](/inheritance/reading-whats-operating/network-effects) can turn a focal point into a durable standard once adoption accumulates. [Rules-in-Use](/inheritance/reading-whats-operating/rules-in-use) asks whether the convention actually governs behavior under pressure.

**Across the Inheritance.** Common Knowledge Generation in Bond is the natural partner: Schelling Points can arise without explicit communication, while common knowledge can be deliberately built when tacit salience is not enough. Mechanism Design may later formalize a focal point into a rule, default, or standard.
