...
The tool has limits. "Emergence" is often abused as a sophistication marker. It can hide ignorance, excuse vague thinking, or make ordinary causality sound profound. The discipline is to use the term only when it sharpens the reading: parts interacting under conditions produce a system-level pattern that shapes behavior and can be investigated.
...
**Within the category.** [Feedback Loops](/inheritance/reading-whats-operating/feedback-loops) reads one mechanism by which emergent patterns reproduce themselves. [Network Effects](/inheritance/reading-whats-operating/network-effects) reads emergent value, cost, and lock-in created by adoption. [Leverage Points](/inheritance/reading-whats-operating/leverage-points) asks where changing an interaction, information flow, rule, or goal might alter what emerges. [Entropy](/inheritance/reading-whats-operating/entropy) reminds the reader that emergent order has maintenance costs and can decay.

**Across the Inheritance.** [Architecture](/inheritance/reading-whats-operating/architecture) carries the category-level claim that the reader must move across scale and temporal horizon. Emergence is one reason that movement is necessary: the operative pattern may exist at a different scale than the one first inspected.
