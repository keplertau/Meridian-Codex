...
**Within the category.** [Moloch](/inheritance/reading-whats-operating/moloch) reads the race once shared values are sacrificed for position. [Network Effects](/inheritance/reading-whats-operating/network-effects) can make a Red Queen race accelerate when adoption by others changes the cost of standing still. [Feedback Loops](/inheritance/reading-whats-operating/feedback-loops) reads the adaptive loop through which one move becomes another actor's input.

**Across the Inheritance.** [Antifragility](/inheritance/reading-whats-operating/antifragility) asks whether the adaptive pressure strengthens the system or consumes it. Mechanism Design becomes relevant when the question shifts to whether the rules can slow or redirect the treadmill.
