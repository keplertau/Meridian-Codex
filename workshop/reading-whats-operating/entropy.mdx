---
title: "Entropy"
description: "Order is not the default — structures drift toward disorder unless work is done to maintain them. The lens for how systems lose their operative properties over time, and the physical ground beneath the Codex's framing of Control and Decay as two equilibria."
aiSummary: "Entropy is the physical-law lens inside Reading What's Operating: order requires sustained energy to hold against the default drift toward disorder. The mechanism (second law of thermodynamics; open vs closed systems; entropy producing specific patterns in human systems rather than random noise; the Codex framing Control and Decay as two equilibrium endpoints, both entropic failures), the practice (entropy audit, maintenance budget, freeze check), the lineage (Clausius, Boltzmann, Schrödinger, Shannon, Meadows; the Codex's specific contribution naming Control as a frozen equilibrium alongside Decay's dissolved one), and cross-references inside Reading What's Operating and across the Workshop."
