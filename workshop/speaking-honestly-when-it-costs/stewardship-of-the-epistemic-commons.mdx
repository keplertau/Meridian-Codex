...
**Why this tool is in the Workshop.** Stewardship of the Epistemic Commons is here because public information behavior is cooperative conduct. Signal vs Noise, Information Degradation, and Report Fidelity handle evidence selection, transmission, and report warrant. This tool asks the Bond-side question: what are you putting into circulation, and does it help others coordinate around reality? It belongs in Keeping Shared Signal Honest because the category governs responsibility for information once it enters the common field.
