...
Graduated Reciprocity is how trust becomes safer without becoming small. The practice begins with a cooperative move that gives the other party something to respond to and limits exposure enough that a failure will not destroy the relationship. Then it watches what comes back. If the other party reciprocates, trust can expand. If they defect, ignore, exploit, or respond asymmetrically, the next move changes.
...
**Within the category.** Graduated Reciprocity uses [Good Faith as Default](/inheritance/calibrating-trust-to-behavior/good-faith-as-default) as the opening posture and [Trust Diagnostics](/inheritance/calibrating-trust-to-behavior/trust-diagnostics) as the assessment layer. [Skin in the Game](/inheritance/calibrating-trust-to-behavior/skin-in-the-game) changes how quickly trust should scale: shared downside supports larger steps; offloaded downside calls for smaller ones.

**Across the Inheritance.** [Prisoner's Dilemma](/inheritance/reading-whats-operating/prisoners-dilemma) carries the strategic structure this tool practices in relational form. Repairing After Rupture will carry the formal repair sequence when trust has already been breached. [Cooperating Under Bad Faith](/inheritance/cooperating-under-bad-faith) is the boundary condition: if the other party uses small trust extensions as extraction opportunities, graduated reciprocity should slow or stop rather than keep offering material for exploitation.
