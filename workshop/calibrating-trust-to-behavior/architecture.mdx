...
aiSummary: "Architecture page for Bond -> Calibrating Trust to Behavior. Range-vantage articulation: this category carries the Bond's basic trust discipline. It holds against Control through suspicion as default and against Decay through naive trust, identity-trust, or trust that no longer updates. The tools inside are Good Faith as Default, Trust Diagnostics, Graduated Reciprocity, Skin in the Game, and Trust Thermocline. Cross-references: the three-discipline accountability triad with Foundation -> Calibrating Confidence to Evidence and Reality -> Checking Your Map Against Reality; boundary with Cooperating Under Bad Faith, which studies intentional and structural exploitation of cooperative trust; chapter note: Bond section 04 names calibrated trust directly, and this category expands that chapter posture into operational tools."
discipline: bond
