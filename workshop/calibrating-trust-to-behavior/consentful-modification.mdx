...
**Across to Knowledge.** [Objective-Trace Audit](/workshop/checking-your-map-against-reality/objective-trace-audit) asks what objective behavior appears to serve after a change. Memory Provenance will matter when memory edits become load-bearing: the system needs to know whether a memory was corrected, inserted, summarized, inherited, or poisoned.
