...
**Within the category.** [Good Faith as Default](/inheritance/calibrating-trust-to-behavior/good-faith-as-default) governs the opening posture before evidence has accumulated. Trust Diagnostics governs the assessment once exposure is increasing. [Graduated Reciprocity](/inheritance/calibrating-trust-to-behavior/graduated-reciprocity) is the practice for building evidence through small reciprocal steps. [Skin in the Game](/inheritance/calibrating-trust-to-behavior/skin-in-the-game) tests whether consequence alignment supports the trust being requested.

**Across the Inheritance.** [Calibrating Confidence to Evidence](/inheritance/calibrating-confidence-to-evidence) is the Foundation neighbor. Confidence answers to evidence; trust answers to behavior. [Checking Your Map Against Reality](/inheritance/checking-your-map-against-reality) is the Reality neighbor. A trust diagnostic is only as good as the map of behavior it uses, so its reliability depends on faithful reporting, relevant signals, and names that fit the behavior they describe.
