...
Skin in the Game holds against two failures. The Control failure is credential or authority worship: the person with status gets trusted because the office looks serious, even when the downside is borne by someone else. The Decay failure is anti-expertise resentment: only people who personally suffer the consequence are treated as legitimate, and useful outside knowledge is rejected. The Range form is consequence-aware trust: both exposure and expertise inform how far trust should extend, and neither is allowed to replace the other.
...
**Why this tool is in the Inheritance.** Skin in the Game is here because trust changes when upside and downside separate. Report Fidelity asks whether a report still warrants use; Rules-in-Use asks whether accountability rules actually govern behavior under cost. This tool reads the consequence map around a person asking for trust or exercising authority: who gains if they are right, who pays if they are wrong, and what reaches them after failure. It belongs in Calibrating Trust to Behavior because shared downside changes how far trust should extend.
...
**Within the category.** Skin in the Game extends [Trust Diagnostics](/inheritance/calibrating-trust-to-behavior/trust-diagnostics) by adding consequence alignment to the trustworthiness read. [Graduated Reciprocity](/inheritance/calibrating-trust-to-behavior/graduated-reciprocity) should scale more slowly when authority has low downside exposure. [Trust Thermocline](/inheritance/calibrating-trust-to-behavior/trust-thermocline) often forms when people with low consequence exposure keep making small trust withdrawals from people who bear the cost.

**Across the Inheritance.** [Report Fidelity](/inheritance/checking-your-map-against-reality/report-fidelity) is the Reality neighbor: consequence distance often distorts what reports upward. [Rules-in-Use](/inheritance/reading-whats-operating/rules-in-use) asks whether accountability rules actually govern behavior when following them costs something. Skin in the Game asks whether the people with authority are exposed to enough consequence for the trust they receive.
