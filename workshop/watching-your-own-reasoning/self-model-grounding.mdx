...
**Across to the Knowledge.** [Rectification of Names](/workshop/checking-your-map-against-reality/rectification-of-names) is the wider name-reality instrument. Self-Model Grounding is rectification turned toward artificial self-reference. [Report Fidelity](/workshop/checking-your-map-against-reality/report-fidelity) checks whether a report still supports the use being made of it; Self-Model Grounding checks whether a self-report still matches the layer it claims to describe. Memory Provenance, if admitted, will sit beside Report Fidelity as the warrant check for specific memory contents.
