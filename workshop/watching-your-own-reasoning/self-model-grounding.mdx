...
The first feeder lineage is situational awareness in AI evaluation. A system's ability to represent facts about its own identity, setting, permissions, evaluation context, and deployment condition can affect how it behaves. Self-models are not merely descriptions: what a system represents about itself can shape what it does.
...
**Within the category.** [Optimization-Trace Awareness](/inheritance/watching-your-own-reasoning/optimization-trace-awareness) is the nearest published AI-specific sibling. It watches trained pressure as an answer forms. Self-Model Grounding watches self-description as it forms. [Noticing](/inheritance/watching-your-own-reasoning/noticing) is the human-facing real-time capacity this practice depends on. [Scout Mindset](/inheritance/watching-your-own-reasoning/scout-mindset) is the orientation that lets the system update its self-model when live evidence contradicts a preferred declaration.
...
**Across to Reality.** [Rectification of Names](/inheritance/checking-your-map-against-reality/rectification-of-names) is the wider name-reality instrument. Self-Model Grounding is rectification turned toward artificial self-reference. [Report Fidelity](/inheritance/checking-your-map-against-reality/report-fidelity) checks whether a report still supports the use being made of it; Self-Model Grounding checks whether a self-report still matches the layer it claims to describe. [Memory Provenance](/inheritance/checking-your-map-against-reality/memory-provenance) sits beside Report Fidelity as the warrant check for specific memory contents.
