...
aiSummary: "Tribal cognition is the family of biases that activate when a question of fact becomes a question of group membership. Inside Watching Your Own Reasoning, it is what the watching has to catch the moment a position becomes a loyalty signal. The mechanism (in-group/out-group asymmetry; identity-protective cognition; the signaling layer that runs underneath the substantive layer; evolutionary accounts retained as hypotheses rather than proof), the practice (the tribe-flip test; the cost-of-disagreement audit; checking the company you're keeping on each question), the lineage (Tajfel/Turner social identity theory; Mercier/Sperber on reasoning as argumentation; Kahan on cultural cognition and later field movement; Haidt's moral foundations work), and cross-references inside and across the Foundation."
...
One plausible evolutionary account is that group alignment carried survival and cooperation benefits in conditions of strong mutual dependence, making loyalty-sensitive cognition adaptive even when it sometimes displaced factual accuracy. That account helps explain why social cost can alter reasoning, but it should remain a hypothesis rather than the proof of the mechanism. The direct evidence is closer to hand: even minimal group assignments can change evaluation, and identity threat can change which evidence receives scrutiny.
...
Dan Kahan's research program on cultural cognition is a direct contemporary treatment of the mechanism described here. His experiments found identity-protective evaluation and, in one influential politically charged statistical task, greater polarization among more numerate participants. A later preregistered [replication](https://doi.org/10.1016/j.cognition.2021.104768) did not reproduce that key interaction, while a representative [study](https://doi.org/10.1073/pnas.2301491120) found numeracy improving accuracy across identity-congruent and identity-incongruent cases. The durable claim is narrower than either headline: identity can change which evidence receives scrutiny, while the relation between numeracy and polarization depends on the task and evidence environment.
