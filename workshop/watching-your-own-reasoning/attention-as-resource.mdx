...
Attention-capture systems recruit fast orienting, reward-learning, and social-salience processes before reflective control has fully engaged. Deliberate attention is not housed in one separate “rational” layer; it emerges from distributed systems that compete and cooperate with those faster pulls. The practical result is enough for this profile: people can find their attention already redirected before they have consciously evaluated whether the redirection serves them. The later feeling of choice may therefore contain both real agency and post-hoc justification.
...
**Why this tool is in the Inheritance.** Attention as Resource is here because the category cannot only teach what to notice after attention has already been captured. Noticing watches what enters the field. Wise Attention directs attention within the field. This profile makes the field itself visible: scarcity, fragmentation, and engineered capture shape what honest inquiry has available. The rest of the Foundation needs enough sustained attention to work at all.
