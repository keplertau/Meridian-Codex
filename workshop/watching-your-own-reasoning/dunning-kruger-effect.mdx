...
**Within the category.** [Noticing](/inheritance/watching-your-own-reasoning/noticing) is the in-moment practice that catches the felt confidence rising on insufficient evidence — the somatic signal of certainty that does not match the actual calibration. [Confirmation Bias](/inheritance/watching-your-own-reasoning/confirmation-bias) compounds: a mind that is overestimating its skill will preferentially seek evidence consistent with that estimate, and the filter will reinforce the bias. [Motivated Reasoning](/inheritance/watching-your-own-reasoning/motivated-reasoning) compounds further: the motivation to maintain a particular self-image generates the arguments that defend the inflated self-assessment.
