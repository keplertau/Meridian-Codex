...
The next time you face a consequential decision, pause briefly and ask what your attention is on — surface or root, the framing or what is producing the framing, the salient feature or the operative cause. If the answer is the wrong layer, redirect.

<div className="glass-card">

**Why this tool is in the Inheritance.** Wise Attention is here because attention-cultivation needed a practice, not only a warning about capture. Attention as Resource names the contest over attention; Wise Attention teaches the upstream selection of what receives attention before reasoning begins. It is distinct from Noticing, which catches cognitive events after they fire. The Buddhist lineage supplies a precise practice for directing attention to root rather than surface, filling the category's missing half without turning it into generic mindfulness.
