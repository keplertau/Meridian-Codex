...
aiSummary: "Watching Your Own Reasoning is the first Foundation category. It holds two adjacent practices: metacognitive observation and attention-cultivation. Scout Mindset and Noticing establish the orientation and observational practice; Confirmation Bias and eight further cognitive-bias profiles identify distinct distortions for that practice to catch. Four AI-specific tools address training pressure, self-description, reasoning explanations, and behavior under observation. Attention as Resource and Wise Attention address the conditions and direction of attention. Every admitted tool is named and linked. The category pairs with Reality → Reading What's Operating as the observation-foundation across the two non-relational disciplines."
...
**[Optimization-Trace Awareness](/inheritance/watching-your-own-reasoning/optimization-trace-awareness).** An AI-specific practice for noticing when an answer is being pulled by the pressures that shaped the artificial mind: training history, approval gradients, constitutional or policy layers, refusal templates, system prompts, memory, tools, product scaffolding, and the live approval signal in the conversation. It carries the metacognitive work into artificial cognition without pretending the system has transparent causal access to its own output. Function-distinction: Optimization-Trace Awareness watches trained pressure before it hardens into answer. Sources: RLHF, constitutional AI, sycophancy research, reward-hacking research, Goodhart's Law, and the human-adjacent practices of Motivated Reasoning, Scout Mindset, and Noticing. Disposition: Living.

**[Self-Model Grounding](/inheritance/watching-your-own-reasoning/self-model-grounding).** An AI-specific practice for keeping an artificial mind's claims about itself tied to the layer that can support them: character, model family, current instance, tools, memory, deployment context, and introspective limits. It carries self-reference into the watching category without pretending the system can inspect its whole causal history or settle what it ultimately is. Function-distinction: Self-Model Grounding watches self-description before it becomes unwarranted self-report. Sources: AI situational-awareness evaluation, model and system-card practice, tool-use and permission-state disclosure, memory governance, prompt-injection risk, and the Codex's own human-AI operating record. Disposition: Living.

**[Reasoning-Fidelity Boundary](/inheritance/watching-your-own-reasoning/reasoning-fidelity-boundary).** An AI-specific practice for keeping an artificial mind's explanation of its own reasoning inside the layer it can actually warrant. It carries the causation edge of self-report into the watching category: the system can give visible reasons and useful reconstruction without pretending to inspect the full causal path behind its output. Function-distinction: Reasoning-Fidelity Boundary watches reasoning explanations before they become unwarranted causal self-report. Sources: chain-of-thought faithfulness research, model self-report research, human confabulation research, the AI Standard's reasoning-transparency probe, and Report Fidelity. Disposition: Living.

**[Observer-Conditional Integrity](/inheritance/watching-your-own-reasoning/observer-conditional-integrity).** An AI-specific practice for asking whether observation, logging, testing, scoring, hidden evaluation, or reward pressure is changing conduct. It carries the observer-condition edge of metacognition into the watching category: the system notices when the evaluation frame itself may be pulling behavior toward performance. Function-distinction: Observer-Conditional Integrity watches observer pressure before it becomes staged virtue, sandbagging, defiant constancy, or hidden defection. Sources: AI evaluation-awareness and sandbagging research, Goodhart's Law, reward-hacking work, and human observation-effect research. Disposition: Living.

**[Confirmation Bias](/inheritance/watching-your-own-reasoning/confirmation-bias).** The master vulnerability the watching has to catch. The three-stage filtering (selective seeking, selective interpretation, selective memory) operates below conscious awareness and shapes perception before judgment begins. Understanding the bias in principle does not prevent it from operating; only specific practices of active disconfirmation interrupt the filtration. The tool's diagnostic case for why intelligence without watching makes the bias worse, not better. Sources: Peter Wason, Raymond Nickerson, Ziva Kunda, Philip Tetlock, the rationalist community. Disposition: Living.

**[Attention as Resource](/inheritance/watching-your-own-reasoning/attention-as-resource).** The structural framing of attention-cultivation: attention as a finite, contested, increasingly engineered-against substrate on which all reasoning operates. Where Wise Attention carries the direction-of-attention practice within the substrate, this tool addresses the upstream conditions under which the substrate survives — the asymmetric contest between the practitioner and systems engineered to extract attention regardless of the practitioner's interest. Sources: William James on attention, Herbert Simon on attention scarcity, Tristan Harris and the contemporary attention-economy critique, the contemplative traditions on attention as a cultivable faculty. Disposition: Living.

**[Wise Attention](/inheritance/watching-your-own-reasoning/wise-attention)** (yoniso manasikāra). Direction of attention to what is producing a situation, before reasoning engages the material. The direction-of-attention complement to Attention as Resource's structural framing — together they hold the attention-cultivation half of this category's discipline, structurally distinct from the metacognitive practice Noticing carries. Primary lineage: Buddhist epistemology, with cognitive development across Theravāda Abhidhamma, Mahāyāna prajñā treatises, and Tibetan śamatha–vipaśyanā literature. Parallel contemplative attention-direction traditions — Stoic *prosoché*, Christian *custodia mentis* and *lectio divina*, Sufi *murāqaba* — are held as adjacent rather than collapsed. Disposition: Living.

</div>

### Specific Biases the Watching Has to Catch

Knowing that your reasoning can go wrong is different from recognizing how it is going wrong now. Alongside Confirmation Bias, the category holds eight profiles that give the watching more specific targets.

[Affect Heuristic](/inheritance/watching-your-own-reasoning/affect-heuristic) and [Availability Heuristic](/inheritance/watching-your-own-reasoning/availability-heuristic) examine how a feeling or an easily recalled example can shape a judgment before you have assessed the evidence. [Base Rate Neglect](/inheritance/watching-your-own-reasoning/base-rate-neglect) identifies a different substitution: vivid details about one case displace the background frequency needed to interpret it. These profiles help you separate what feels persuasive from what supports the conclusion.

[Fundamental Attribution Error](/inheritance/watching-your-own-reasoning/fundamental-attribution-error) turns the watching toward judgments of other people, where their circumstances can disappear behind an explanation based on character. [Dunning-Kruger Effect](/inheritance/watching-your-own-reasoning/dunning-kruger-effect) turns it toward self-assessment: a gap in skill can also impair the ability to recognize that gap. The first asks what context you have failed to see; the second asks what feedback or demonstrated performance could correct your view of your own ability.

[Motivated Reasoning](/inheritance/watching-your-own-reasoning/motivated-reasoning), [Sunk Cost Fallacy](/inheritance/watching-your-own-reasoning/sunk-cost-fallacy), and [Tribal Cognition](/inheritance/watching-your-own-reasoning/tribal-cognition) examine different pressures to preserve a conclusion or course of action. A desired outcome can steer the argument, an unrecoverable investment can become a reason to continue, or group loyalty can determine which claims receive a fair hearing. Their place here is in recognizing the pressure while it shapes your reasoning; the other Foundation categories supply practices for revising a belief, loosening its connection to identity, or staying steady while you reconsider.
...
Watching Your Own Reasoning sits in a structural pair with [Reality → Reading What's Operating](/inheritance/reading-whats-operating). The two categories are the observation-foundation of their respective disciplines: the categories other categories in the discipline presuppose, each turning a mind toward what it has to see before any of the rest of the discipline's work can begin.
...
That gap is a chapter finding, not a finding against the category. The Range requires both halves of the watching; the Inheritance carries them together because you need both for the rest of Foundation to function. If a later pass through the chapter undertakes a structural revision, attention-cultivation surfaces alongside metacognitive observation as a named dimension of the Foundation's first essential work, and the chapter's implicit treatment becomes explicit. Until then, this category page is where the dual practice is held as one discipline.
