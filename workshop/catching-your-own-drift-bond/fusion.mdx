...
**Why this tool is in the Workshop.** Fusion belongs in Catching Your Own Drift - Bond because it names the Control-side drift that appears before a group visibly suppresses dissent: a person starts protecting a bond from the truth it needs. It is not a warning against care, loyalty, or repair. The narrower failure is attachment overriding correction. Groupthink shows the group field that can result; Speaking Honestly When It Costs is one counterpractice. Fusion gives the reader the earlier, more intimate diagnostic: the moment care starts asking honesty to wait.
