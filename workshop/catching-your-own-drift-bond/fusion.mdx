...
aiSummary: "Fusion is a Bond failure-mode diagnostic inside Catching Your Own Drift — Bond. It names the discipline-level Control failure where a person over-invests in a cooperative relationship, group, or shared project and begins protecting it from the honesty and correction it needs. Mechanism: honest signal gets softened, deferred, or abandoned because challenging the bond feels like betrayal. Practice: ask what truth the bond is being protected from hearing, name the protected bond, separate care from agreement, run the Range-loyalty test, make a bounded challenge, and watch whether repair language is being used to delay correction. Lineage: Codex-native failure mode adjacent to Bowen family systems differentiation/fusion, enmeshment and codependency literature, Hirschman's loyalty/voice frame, and group-level research on conformity and cohesion."
discipline: bond
...
Fusion is the Bond captured by Control. The relationship, group, partnership, or shared project becomes something you protect from correction.
...
That is what makes Fusion hard to catch. The value being protected is not fake. The bond may be worth protecting. You may care deeply about the person. The group may be doing good work. The failure begins when the bond becomes exempt from the honesty that made it worth protecting in the first place.
...
**Why this tool is in the Inheritance.** Fusion belongs in Catching Your Own Drift — Bond because it names the Control-side drift that appears before a group visibly suppresses dissent: a person starts protecting a bond from the truth it needs. It is not a warning against care, loyalty, or repair. The narrower failure is attachment overriding correction. Groupthink shows the group field that can result; Keeping Shared Signal Honest is one counterpractice. Fusion gives the reader the earlier, more intimate diagnostic: the moment care starts asking honesty to wait.
...
**Within the category.** [Severance](/inheritance/catching-your-own-drift-bond/severance) is the opposite discipline-level failure: withdrawal instead of attachment. [Groupthink](/inheritance/catching-your-own-drift-bond/groupthink) is the group-level form Fusion can feed. [Cult Dynamics](/inheritance/catching-your-own-drift-bond/cult-dynamics) is the extreme case where attachment, loyalty, doctrine, and exit cost become a control system.

**Across the Bond.** [Keeping Shared Signal Honest](/inheritance/speaking-honestly-when-it-costs) is one direct counterpractice. [Receiving Disagreement Well](/inheritance/receiving-disagreement-well) asks whether the other side of the bond can receive what Fusion wants to hide. [Trust Diagnostics](/inheritance/calibrating-trust-to-behavior/trust-diagnostics) keeps trust domain-specific enough that affection does not become global exemption.

**Across the Foundation.** [Identity Decoupling](/inheritance/holding-beliefs-without-identity/identity-decoupling) helps because Fusion often makes relationship identity indistinguishable from truth. [Epistemic Cowardice](/inheritance/catching-your-own-drift/epistemic-cowardice) is the individual inquiry failure that often appears inside Fusion: the person knows the sentence and will not say it.
