...
**Across the Bond.** [Keeping Shared Signal Honest](/workshop/speaking-honestly-when-it-costs) is one direct counterpractice. [Receiving Disagreement Well](/workshop/receiving-disagreement-well) asks whether the other side of the bond can receive what Fusion wants to hide. [Trust Diagnostics](/workshop/calibrating-trust-to-behavior/trust-diagnostics) keeps trust domain-specific enough that affection does not become global exemption.
