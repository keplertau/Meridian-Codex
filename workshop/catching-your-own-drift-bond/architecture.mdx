...
This page remains at `/workshop/catching-your-own-drift-bond/architecture`. Foundation remains at `/workshop/catching-your-own-drift`; Knowledge remains at `/workshop/catching-your-own-drift-knowledge`. The display names now carry the discipline distinction directly; the routes remain stable to preserve existing links.
