...
People defect because they expect defection. They withhold information because they expect others to withhold. They grab resources because they expect others to grab first. They leave the channel because they believe the channel can no longer support shared decisions or commitments. The collapse is not only private fear. It is fear about what everyone else now believes.
...
**Why this tool is in the Inheritance.** Coordination Collapse belongs in this category because it names the acute Decay failure of cooperation under shock. The group does not slowly drift; shared expectations break quickly enough that self-protection becomes locally rational for many people at once. Defection Cascades cover the slower erosion that can prepare the break. Common Knowledge Generation helps repair it. Coordination Collapse gives the Inheritance a diagnostic for the moment when the shared field has to be made legible again before trust can be asked for.
...
**Within the category.** [Defection Cascades](/inheritance/catching-your-own-drift-bond/defection-cascades) are the chronic version: the gradual normalization of defection before collapse becomes visible. [Severance](/inheritance/catching-your-own-drift-bond/severance) can spread into Coordination Collapse when enough people withdraw at once. [Echo Chambers](/inheritance/catching-your-own-drift-bond/echo-chambers) can make collapse harder to repair by making each side's fear self-confirming.

**Across the Bond.** [Common Knowledge Generation](/inheritance/repairing-after-rupture/common-knowledge-generation) is one direct repair instrument. [Trust Thermocline](/inheritance/calibrating-trust-to-behavior/trust-thermocline) often precedes collapse: trust erodes invisibly and then drops all at once. [Schelling Fences](/inheritance/diagnosing-cooperation/schelling-fences) can prevent gradual exceptions from setting up the break.

**Across Reality.** [Prisoner's Dilemma](/inheritance/reading-whats-operating/prisoners-dilemma), [Schelling Points](/inheritance/reading-whats-operating/schelling-points), and [Nash Equilibrium](/inheritance/reading-whats-operating/nash-equilibrium) give the strategic background: people can land in a worse stable pattern even when better cooperation would be possible.
