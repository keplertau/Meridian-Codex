...
This is why Echo Chambers sit in the Bond, not only in Reality. The map fails, but the failure is carried by relationship: who is trusted, who is heard, whose testimony counts, and whose contradiction arrives pre-discredited.
...
**Why this tool is in the Inheritance.** Echo Chambers belong here because the failure is relational before it is informational. The group does not merely lack outside evidence; it has learned whom not to trust before they speak. That makes it a Bond diagnostic, not only a Reality problem. Ideology names the model becoming sovereign over evidence. Information Degradation tracks what happens as signal travels. Echo Chambers name the trust-system closure that decides which signals are allowed to count as signal at all.
...
**Within the category.** [Groupthink](/inheritance/catching-your-own-drift-bond/groupthink) suppresses dissent inside the room. Echo Chambers shape what the room receives from outside. [Cult Dynamics](/inheritance/catching-your-own-drift-bond/cult-dynamics) can absorb both into a totalizing membership system.

**Across Reality.** [Ideology](/inheritance/catching-your-own-drift-knowledge/ideology) is the model becoming sovereign over evidence. Echo Chambers are one social mechanism by which the model stays sovereign. [Information Degradation](/inheritance/checking-your-map-against-reality/information-degradation) reads what happens as signal travels; Echo Chambers read which signals are allowed to count as signal at all.

**Across the Foundation.** [Confirmation Bias](/inheritance/watching-your-own-reasoning/confirmation-bias) and [Tribal Cognition](/inheritance/watching-your-own-reasoning/tribal-cognition) are individual mechanisms that chambers can amplify into group structure.
