...
**Within the category.** [Groupthink](/inheritance/catching-your-own-drift-bond/groupthink) can be an early-stage form of suppressed dissent. [Echo Chambers](/inheritance/catching-your-own-drift-bond/echo-chambers) can provide the informational closure Cult Dynamics require. Cult Dynamics intensify both by making dissent and outside correction threats to membership.

**Across the Bond.** Belonging Through Practice will carry the positive form this failure corrupts: belonging produced by shared practice, not loyalty to belief, leader, or identity. [The Exclusion Problem](/inheritance/cooperating-under-bad-faith/exclusion-problem) is a boundary guardrail because groups can use anti-cult language to justify coercive exclusion. [Repairing After Rupture](/inheritance/repairing-after-rupture) matters because exit, return, apology, and accountability all become distorted when the group controls membership too tightly.
