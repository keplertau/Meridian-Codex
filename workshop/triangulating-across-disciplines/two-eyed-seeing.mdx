...
**Across the Bond.** Calibrating Trust to Behavior and Repairing After Rupture become relevant because knowledge-system plurality is relational. Trust, history, power, and repair decide whether co-learning is possible. Without that Bond work, Reality tool can become another extraction path.
