...
**Why this tool is in the Inheritance.** Two-Eyed Seeing is here because some triangulation problems are not only between analytical tools. They sit between ways of knowing, with different authorities, relationships, places, memories, and obligations. Anekāntavāda / Syādvāda disciplines standpoint-bound claims; this tool disciplines the relation between knowledge systems. It is not a metaphor for any two perspectives. It belongs in this category because Reality needs a way to hold source, authority, reciprocity, and benefit visible when more than one way of knowing is asked to see.
...
**Within the category.** [Anekāntavāda / Syādvāda](/inheritance/triangulating-across-disciplines/anekantavada-syadvada) disciplines standpoint and conditional speech. Two-Eyed Seeing disciplines knowledge-system relation. The first asks how a claim is true from a standpoint. The second asks whether the ways of knowing are being held together without erasure.

**Across Reality.** [Dependent Origination](/inheritance/reading-whats-operating/dependent-origination) helps read the conditions that make a knowledge conflict appear. [Polycentric Governance](/inheritance/reading-whats-operating/polycentric-governance) helps read multiple centers of decision and authority. [Rectification of Names](/inheritance/checking-your-map-against-reality/rectification-of-names) asks whether labels like partnership, consultation, co-design, or inclusion match the conduct they claim.

**Across the Bond.** Calibrating Trust to Behavior and Repairing After Rupture become relevant because knowledge-system plurality is relational. Trust, history, power, and repair decide whether co-learning is possible. Without that Bond work, the Reality tool can become another extraction path.
