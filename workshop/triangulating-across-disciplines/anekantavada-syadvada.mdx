...
*Reality · Triangulating Across Disciplines*
...
The Codex translation is strict. This page does not claim to reproduce Jain doctrine, settle interpretive debates inside Jain studies, or use Jain philosophy as decorative proof that the Codex was right already. It inherits one portable mechanism for Reality: state claims conditionally, from a standpoint, with scope visible.
...
**Within the category.** [Two-Eyed Seeing](/inheritance/triangulating-across-disciplines/two-eyed-seeing) moves from standpoint discipline into knowledge-system plurality. Anekāntavāda / Syādvāda asks how a claim is true from a standpoint. Two-Eyed Seeing asks how different ways of knowing can see together without erasure.

**Across Reality.** [Checking Your Map Against Reality](/inheritance/checking-your-map-against-reality) keeps every conditional claim answerable to the territory. [Signal vs Noise](/inheritance/checking-your-map-against-reality/signal-vs-noise) asks whether a standpoint has produced information that should move the map.

**Across the Foundation and Bond.** [Charitable Interpretation](/inheritance/holding-beliefs-without-identity/charitable-interpretation) keeps another person's claim from being reduced too quickly. [Steelmanning](/inheritance/revising-beliefs-under-evidence/steelmanning) builds the strongest version of a view before testing it. Double Crux and Productive Conflict become stronger when conditional claims make the hinge visible.
