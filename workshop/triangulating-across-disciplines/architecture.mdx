...
description: "The architecture of Reality's meta-methodological category: using multiple lenses without single-lens capture or perspective collage."
aiSummary: "Architecture page for Reality -> Triangulating Across Disciplines. Range-vantage articulation: the category holds Reality's meta-methodological discipline of using multiple instruments and knowledge systems without collapsing them into one master lens or dissolving into undecidable plurality. Control = single-lens sovereignty, expert monopoly, source erasure, or forced commensurability; Decay = perspective collage, all-lenses-equal relativism, endless qualification, or refusal to decide. The category operates at a different kind level from other Reality categories: it teaches how to use the instruments, not one instrument among them. Tool profiles at v0.1: Anekantavada / Syadvada for conditional standpoint discipline, and Two-Eyed Seeing for knowledge-system plurality. Chapter relationship: the Reality chapter's Instruments section says the instruments triangulate rather than converge; this category operationalizes the method of triangulation the chapter names."
discipline: reality
...
Reality is not a single instrument. It is a discipline for reading reality, and reality keeps refusing to fit one instrument's shape.
...
**[Anekāntavāda / Syādvāda](/inheritance/triangulating-across-disciplines/anekantavada-syadvada).** The Jain source-inherited discipline of non-one-sidedness and conditional speech. It teaches you to state claims from a standpoint, under conditions, and with scope visible. Inside this category, it protects triangulation from single-standpoint capture and from lazy "all views are true" relativism.

**[Two-Eyed Seeing](/inheritance/triangulating-across-disciplines/two-eyed-seeing).** The Mi'kmaw source-inherited principle of learning to see from the strengths of Indigenous ways of knowing and Western ways of knowing together. Inside this category, it extends triangulation beyond analytical-tool plurality into knowledge-system plurality, with source, relationship, and reciprocity kept visible.
...
Together, they give the category its first v0.1 spine. Future candidates may add methods for formal cross-disciplinary triangulation, adversarial model comparison, or the Inheritance's own instrument-audit practice. Those are not published here until they clear the same source-lineage and functional-fit bar.
...
the Reality chapter already names the core move. In "The Instruments," it says the instruments do not converge on a single finding. They triangulate. That line is one of the chapter's cleanest statements of method: Reality is not a hidden theory looking for supporting evidence. It is a discipline that reads across instruments because each instrument exposes different mechanics.

This category operationalizes that sentence. The chapter says what Reality does at the level of architecture. Triangulating Across Disciplines teaches the practice: how to keep each lens partial, how to let lenses correct one another, how to resist both single-lens sovereignty and perspective collage, and how to translate source-inherited tools without pretending the Codex invented what it inherited.

The category also extends the chapter's instrument section in one specific direction. The chapter mostly describes analytical instruments. This page adds the knowledge-system layer. That extension is not a correction of the chapter so much as a build-out the Inheritance made visible: some forms of seeing are not merely alternate tools inside the same method. They are carried by communities, practices, languages, places, and obligations. A Reality discipline that cannot admit that layer would eventually mistake its own analytical comfort for reality.
