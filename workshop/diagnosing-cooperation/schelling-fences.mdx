...
**Across the Inheritance.** [Schelling Points](/inheritance/reading-whats-operating/schelling-points) is Reality neighbor: focal points show where coordination converges, while Schelling Fences show where cooperation stops. [Rules-in-Use](/inheritance/reading-whats-operating/rules-in-use) tests whether the fence governs behavior when following it costs something. [Skin in the Game](/inheritance/calibrating-trust-to-behavior/skin-in-the-game) often explains why a fence is needed: people who do not bear downside are more willing to make exceptions.
