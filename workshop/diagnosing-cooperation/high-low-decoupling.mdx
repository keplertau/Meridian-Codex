...
**Reality-system boundary.** [Two-Eyed Seeing](/inheritance/triangulating-across-disciplines/two-eyed-seeing) is not another name for low decoupling. It is a source-inherited knowledge-system practice with its own lineage, relationship, reciprocity, and benefit-for-all obligations. High/Low Decoupling Communication is narrower: a communication diagnostic for norm mismatch around claims and context.
