...
**Why this tool is in the Inheritance.** Psychological Flexibility is here because belief-threat does not stay cognitive. It becomes shame, anger, grief, fear, defensiveness, and bodily bracing, and those states can choose the next move before honest inquiry returns. Identity Decoupling names the belief-self separation; Psychological Flexibility supplies the capacity to stay with the inner cost while acting from values and truth. Its broader pressure function points to Staying Steady Under Pressure, but this profile belongs here because belief-threat tolerance is what keeps identity defense from choosing the belief.
...
**Within the category.** [Identity Decoupling](/inheritance/holding-beliefs-without-identity/identity-decoupling) names the belief-self separation this tool often protects under pressure. [Intellectual Humility](/inheritance/holding-beliefs-without-identity/intellectual-humility) supplies the fallibility stance: I may be wrong and can remain intact. [Charitable Interpretation](/inheritance/holding-beliefs-without-identity/charitable-interpretation) is often the truth-aligned action when the inner experience wants accusation.

**Within the Foundation.** [Noticing](/inheritance/watching-your-own-reasoning/noticing) catches the inner event. Psychological Flexibility changes the response to it. [Affect Heuristic](/inheritance/watching-your-own-reasoning/affect-heuristic) names one way feeling can become evidence; Psychological Flexibility helps feeling remain information rather than command. Staying Steady Under Pressure will carry the broader pressure function when that category is built.
