...
Do not use humility to avoid saying what is clear. When evidence warrants confidence, say the thing. The sentence "I might be wrong" should not become a ritual apology for having a view.
...
**Within the category.** [Identity Decoupling](/inheritance/holding-beliefs-without-identity/identity-decoupling) lowers the threat cost that makes humility hard. [Psychological Flexibility](/inheritance/holding-beliefs-without-identity/psychological-flexibility) helps you remain with the feeling of fallibility. [Charitable Interpretation](/inheritance/holding-beliefs-without-identity/charitable-interpretation) applies humility to the interpretive act: maybe the other person is making a stronger point than your first reading allowed.

**Within the Foundation.** Calibrating Confidence to Evidence is Intellectual Humility turned into measurement discipline. [The Update Protocol](/inheritance/revising-beliefs-under-evidence/the-update-protocol) is the behavioral test: a humble view has update conditions. [Dunning-Kruger Effect](/inheritance/watching-your-own-reasoning/dunning-kruger-effect) names one reason subjective confidence can outrun competence.
