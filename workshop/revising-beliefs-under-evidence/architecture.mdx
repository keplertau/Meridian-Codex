...
**[Murphyjitsu](/workshop/revising-beliefs-under-evidence/murphyjitsu).** The future-facing planning practice that imagines failure in advance, identifies the most plausible break point, patches the plan, and repeats until failure would be surprising. Inside this category, Murphyjitsu treats the plan's assumed success as a belief that must update under simulated evidence before reality supplies harsher evidence. Sources: CFAR's Inner Simulator unit, Murphy's Law, Kahneman and Tversky on mental simulation, prospective hindsight, Gary Klein's premortem method, planning fallacy research. Disposition: Living.
