...
**Across to Knowledge.** [Entropy](/workshop/reading-whats-operating/entropy) explains why plans degrade without maintenance. [Feedback Loops](/workshop/reading-whats-operating/feedback-loops) carries the system-side version: plans should be revised as reality reports back, not defended because they were coherent at the start. The Murphyjitsu variant gives the Foundation-side practice before the feedback arrives.
