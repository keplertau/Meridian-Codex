---
title: "Paralysis"
description: "The Reality Decay failure: uncertainty, complexity, context, and information dissolve judgment until no conclusion can become responsible enough to guide action."
aiSummary: "Paralysis is the Reality Decay failure inside Catching Your Own Drift — Reality. It names the moment intellectual caution loses decision-structure: complexity, uncertainty, context, and information keep accumulating until judgment cannot form or action cannot begin. The profile distinguishes paralysis from legitimate caution, humility, or waiting for missing information. Practice steps: name the decision object, set an evidence threshold, separate reversible from irreversible moves, choose the next reality-contacting action, and keep an update path open."
discipline: reality
...
Paralysis is the Decay failure in Reality. It happens when uncertainty, complexity, context, and information dissolve judgment until nothing can become actionable.
