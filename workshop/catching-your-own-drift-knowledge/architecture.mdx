...
Catching Your Own Drift — Bond diagnoses drift in shared relation: groupthink, echo chambers, cult dynamics, coordination collapse, defection cascades, fusion, and severance. Those are collective cooperation failures. Knowledge's version can feed them, but does not replace them.
...
This page remains at `/workshop/catching-your-own-drift-knowledge/architecture`. Foundation remains at `/workshop/catching-your-own-drift`; Bond remains at `/workshop/catching-your-own-drift-bond`. The display names now carry the discipline distinction directly; the routes remain stable to preserve existing links.
