...
<div className="callout-text">This audit is preserved as a historical record of the Codex at v5.1. It contains earlier wording that treated Control and Decay as an oscillation claim and used a broader convergence frame. The current Codex claim is narrower: viable systems must hold enough structure to preserve function while retaining enough flexibility and variety to adapt. Control and Decay name the two failure directions around that tradeoff, not a necessary historical cycle.</div>
</div>
...
<div id="step-1" className="flow-label">Step 1</div>
...
<div id="step-2" className="flow-label">Step 2</div>
...
<div id="step-3" className="flow-label">Step 3</div>
...
<div id="step-4" className="flow-label">Step 4</div>
...
<div id="step-5" className="flow-label">Step 5</div>
...
<div id="step-6" className="flow-label">Step 6</div>
...
<div id="the-verdict" className="flow-label">The Verdict</div>
