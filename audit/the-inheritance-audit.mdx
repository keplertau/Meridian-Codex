...
<div className="flow-label">01 // What the Inheritance Audit Is</div>
...
**The disciplines.** Foundation, Reality, and Bond. The audit does not reopen the three-discipline structure, which is constitutional and governed by the [Governance Specification](/governance/spec). It reads each discipline as the territory its categories are meant to cover.
