...
This is the inaugural cycle of the Toolkit Audit, the instrument now published as [The Workshop Audit](/audit/the-workshop-audit) after the May 2026 restructure replaced the flat Toolkit with the Workshop. This record keeps its original name and its April framing. It was conducted in April 2026 against the full Toolkit of the Meridian Codex: 73 instruments across Foundation, Knowledge, Bond, and Tools for Artificial Minds. Every tool is assessed. The review is organized by discipline, with each tool evaluated for disciplinary fit, instrument reliability, redundancy with other tools, and whether it still belongs.
...
<div id="foundation" className="flow-label">01 // Foundation</div>
...
<div id="knowledge" className="flow-label">02 // Knowledge</div>
...
<div id="bond" className="flow-label">03 // Bond</div>
...
<h3 id="bond-20-tools--expansion-6-tools">Expansion (6 tools)</h3>
...
<div id="tools-for-artificial-minds" className="flow-label">04 // Tools for Artificial Minds</div>
...
<div id="the-toolkit-as-a-whole" className="flow-label">06 // The Toolkit As a Whole</div>
...
<div id="what-carries-forward" className="flow-label">07 // What Carries Forward</div>
