...
**Current maintenance status.** As of 2026-07-21, the register has not received the complete monthly examination promised by its previous wording. The dates above remain the dates of the last actual examinations. A full-register review is deferred and remains open governance work; until it is completed, the Codex does not claim that every tripwire has been re-examined each month.
