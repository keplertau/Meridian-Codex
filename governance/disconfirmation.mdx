...
<div id="descriptive-claims-full-tripwires" className="flow-label">02 // Descriptive Claims: Full Tripwires</div>
...
### Control and Decay as Failure Directions

**The claim:** Control (structure that cannot adapt) and Decay (structure that cannot hold) name the two failure directions around the Meridian Range. Viable systems must preserve enough structure to keep their function while retaining enough flexibility and variety to adapt. The Pattern is not a claim that history follows a necessary oscillation. It is the recurring pressure on complex systems to fail by becoming too rigid to learn or too loose to hold.

**What would weaken it:** A significant class of complex adaptive systems that fails through a mechanism the Control/Decay model does not capture. If someone produces a diagnostic framework that accounts for the same rigidity and dissolution failures with more precision, or reveals recurring failure modes the Control/Decay vocabulary misses, the model has been weakened or superseded.

**What would strengthen it:** Continued convergent findings across domains (political science, organizational theory, ecology, AI governance, cybernetics, learning theory) that independently describe the same viability tradeoff: structure strong enough to hold function, adaptive capacity broad enough to respond to changed conditions.

**Last examined:** 2026-09-02
...
**What would weaken it:** Sustained evidence that "holding the Range" is not a meaningful operational target. How far apart the Range's two edges are varies by system and by situation, so variation alone does not weaken the claim. What would weaken it is a class of systems whose viable holding cannot be described, at any scale, as regulation governed by reasons and reality that meets the variety the system faces; or evidence that the Range is a momentary equilibrium rather than a holdable position, that systems which reach it cannot remain there without conditions so specific they amount to luck rather than practice. Separately: evidence that a system can thrive long-term by committing fully to one pole, whether pure rigidity that keeps its function by shutting difference out, or pure flexibility with nothing that holds its parts together, in a world whose variety keeps rising, without eventually generating the failure modes the Codex predicts. And: evidence that the three disciplines do not increase what a group can hold, in earned agreement or in reasoned difference, or increase it only by enforcing the one or abandoning the other.
...
**The claim:** The Codex's current three diagnostic questions, applied together, do not systematically miss a critical dimension when assessing a system's position on the Range. Foundation asks: "Is this mind thinking honestly?" Reality asks: "Where does this system sit on the range?" Bond asks: "Is the cooperation genuine or captured?"

**What would weaken it:** Recurring omissions across materially different cases, where available evidence could have supported recognition but the current practices did not elicit it. A serious miss warrants investigation; a pattern can establish a blind spot. The assessment of whether the disciplines were functioning must rest on the record made before the outcome, rather than on whether the outcome was favorable. If a class of failures cannot be recognized through the existing diagnostics without inventing the missing practice afterward, the set needs revision under the Living Framework principle. A failed application, a missing connection between existing tools, and a failure of the discipline decomposition require different repairs.

**Current live edges:** The temporal and stewardship axis remains open. Foundation reads the self across memory, identity, and revision; Reality reads systems across temporal horizons; Bond reads obligation across predecessors, successors, descendants, and other absent parties. Internal architectural review has not established a need for a separate discipline. A second pressure is legitimate disagreement that persists after honest inquiry and cooperation: can the existing practices reveal unjustified authority, overlooked burdens, or absent parties before a binding decision is made? Neither disagreement nor unavoidable loss establishes a diagnostic failure by itself.

**What would strengthen it:** Prospective application across diverse contexts where the diagnostics identify specific risks while action remains possible, including risks a comparison reading misses. Recognition, the quality of the recommended action, and the eventual outcome are separate findings. Agreement among model readers and explanations supplied after the outcome do not demonstrate prospective detection.

**Last examined:** 2026-09-06, internal architectural review and prospective test design. No prospective run or external validation is claimed.

#### Prospective Test

Each run fixes its corpus version, evidence cutoff, case-selection method, and assessment conditions before outcomes are revealed. Use genuinely prospective decisions or unseen cases; a historical outcome already known to the assessor cannot test foresight. Constructed cases test judgment under their stated conditions, not real-world effectiveness.

For each case, preserve the following record before the decision deadline:

1. **What can be protected.** Name the affected parties and the capacities or conditions at stake. Record feasible actions, limits on authority, and any loss that no available action could prevent.
2. **What should be noticed.** State the specific warning, its mechanism, confidence, and the observation or information request that should reveal it. Name the existing practice that should elicit it. Prioritize within the case's time and attention limits; “map better” and unrestricted lists of conceivable dangers do not count as recognition.
3. **What could follow.** Identify a feasible response, who may undertake it, who bears its costs, and when review or revision should occur.
4. **What would count against the reading.** Specify a missed warning, a false alarm, a misleading recommendation, and the conditions under which a conclusion should remain unread. An unread finding is honest uncertainty, but does not count as successful coverage when the evidence made recognition possible.

Select cases that can defeat the expectations: shared scarcity after honest negotiation; an enforceable limit with recourse compared with one that suppresses objection; present agreement exporting costs to absent parties; and emergency powers retained after their warrant ends. Include unavoidable adverse outcomes and reverse which party bears the burden, to test whether bad outcomes or preferred beneficiaries silently change the assessment standard.

A relevantly competent comparison reader receives the same evidence and time limits and originates a reading without the Codex prompts or the assessor's conclusions. Compare specific warnings, false alarms, feasible actions, and overlooked burdens. Preserve disputes about the findings; resemblance to Codex vocabulary does not decide them. The run records reader provenance and relevant prior knowledge.

After the outcome, compare observations with the preserved record. Distinguish a practice omitted despite an available cue, a cue the current practices did not elicit, an inadequate route from recognition to action, and a consequence beyond available control. Mixed or unresolved attribution remains marked as such. Calling a miss “inadequate mapping” must identify the observation available before the outcome and the existing practice that should have elicited it. A later explanation cannot erase the original omission.

Repeated omissions prompt review of the tools and their connections first. Revising the three-discipline decomposition requires evidence that the failure cannot be addressed within it without distortion. Successful cases support usefulness under the tested conditions; they do not establish exhaustive coverage.
...
<div id="normative-claims-conditional-tripwires" className="flow-label">03 // Normative Claims: Conditional Tripwires</div>
...
**The claim:** "The Codex serves the Meridian Range. The caretakers serve the Codex. This hierarchy is inviolable." This hierarchy is the structural commitment that prevents the framework from being captured by the people entrusted with maintaining it.
...
<div id="existential-claims-why-no-tripwire" className="flow-label">04 // Existential Claims: Why No Tripwire</div>
...
**Relationship to the Range Audit.** The monthly Range Audit checks whether new tripwire evidence has appeared. It updates an entry's "Last examined" date only when evidence relevant to that entry was actually examined. Completing a monthly audit does not by itself constitute a full re-examination of this register.

**Current maintenance status.** The first complete examination of this register ran on 2026-09-02, inside the caretakers' Quarterly Integrity Cycle. The register is now examined in full once a quarter; between examinations an entry's date advances only when relevant evidence or argument was actually examined, with the scope of a targeted review stated beside it. Between 2026-07-21 and that first full examination the dates stood as they were, and the Codex claimed no monthly re-examination.
