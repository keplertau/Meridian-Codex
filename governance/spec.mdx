...
<div className="glass-card-text">The skeleton. Procedural mechanisms that define what requires review, how changes are recorded, and what principle governs interpretive authority. Components: Trigger Conditions (three tiers) · The Amendment Log (constitutional instrument) · The Non-Ownership Clause.</div>
</div>
...
<div className="glass-card-text">The immune system. It does not prevent capture in real time. It makes capture visible over time. Visibility enables correction. Components: The Standing Critique Section (published page) · Published deliberation records · The Amendment Log's public history (shared with Structural Layer).</div>
</div>
...
<div className="callout-text">Require Meridian Council deliberation unless urgency demands otherwise. If a Tier 2 change is made without prior deliberation (emergency or time-critical), the council reviews retroactively within 30 days. The exception and its justification are logged in the Amendment Log. (1) Changes to core definitions: Meridian Range, Control, Decay, and the three disciplines' one-sentence job descriptions. (2) Changes to governance criteria, phase transition conditions, alignment criteria, earned autonomy criteria. (3) Changes to the Meridian Compact's definition or its belonging-through-practice mechanism. (4) Addition or removal of tools from the Onramp tier. (5) Changes to the Non-Ownership Clause.</div>
</div>

<div className="callout-tinted note">
<div className="callout-title">Tier 3: Flagged</div>
<div className="callout-text">Changes are logged in the Amendment Log. Review is at the caretaker's discretion. The council may be convened but is not required. (1) Addition or retirement of tools from the Expansion or Full Practice tiers (the Toolkit Audit record serves as the Amendment Log entry). (2) Changes to the AI Standard's commitments. (3) Changes to the Range Audit instruments. (4) Changes to the Codex's claim-layer structure as described in the Proposition.</div>
</div>
