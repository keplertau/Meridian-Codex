...
<div className="def-grid">
<div className="def-item"><div className="def-term">The three-discipline decomposition</div><div className="def-desc">Foundation, Reality, Bond as the current division of labor.</div></div>
...
<div className="def-item"><div className="def-term">The three diagnostic questions</div><div className="def-desc">Foundation, Reality, and Bond's one-sentence evaluative questions.</div></div>
...
<div className="def-item"><div className="def-term">Tool definition structure</div><div className="def-desc">The six-element structure used for every Inheritance tool profile.</div></div>
...
<div className="def-item"><div className="def-term">Inheritance Audit criteria</div><div className="def-desc">The tool and category rubrics used during audit cycles.</div></div>
</div>
...
<div className="def-grid">
<div className="def-item"><div className="def-term">Individual Inheritance profiles</div><div className="def-desc">Each of the registered instruments.</div></div>
...
<div className="def-item"><div className="def-term">Individual Operating Evidence records</div><div className="def-desc">Each published record.</div></div>
</div>
...
<div className="def-item"><div className="def-term">Tier 3: Operational Doctrines</div><div className="def-desc">Trigger Tier 3 (Flagged). Range Audit instrument changes and other Codex operational-doctrine changes are recorded in the Amendment Log at the caretaker's discretion.</div></div>
...
<div className="glass-card">
<div className="glass-card-title">6. The Inheritance's Uneven Cross-Tradition Coverage</div>
