...
<div className="def-item"><div className="def-term">Control and Decay</div><div className="def-desc">Coupled failures that feed each other; the Pattern the framework watches for.</div></div>
...
<div className="def-item"><div className="def-term">The progression structure</div><div className="def-desc">Onramp, Expansion, Full Practice as the staged adoption architecture.</div></div>
</div>
...
<div className="def-item"><div className="def-term">Progression tier composition</div><div className="def-desc">Which tools sit at Onramp vs. Expansion vs. Full Practice (the progression structure is Tier 2; its composition is Tier 4).</div></div>
...
<div className="def-item"><div className="def-term">Tier 3: Operational Doctrines</div><div className="def-desc">Trigger Tier 2 or Tier 3. Onramp-tier Toolkit changes are Protected; AI Standard commitment wording and Range Audit instrument changes are Flagged.</div></div>
...
<div className="glass-card-text"><strong>Descriptive tripwires:</strong> Control and Decay as coupled failures · The Meridian Range as viable territory · The diagnostic set's completeness (Tier 2). <strong>Normative conditional tests:</strong> The Hard Constraint · The partnership principle · The Living Framework principle. <strong>Existential non-tripwires:</strong> The Prime Directive (via the Pathways mechanism) · The Meridian Compact (via Standing Critique monitoring).</div>
</div>
