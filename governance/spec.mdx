...
aiSummary: "The full operational specification of the Governance Layer: trigger conditions (three tiers), the Stability Hierarchy (four-tier content classification), the Amendment Log and its Propagation Rule, the Non-Ownership Clause, the Meridian Council (eight seats with distinct mandates), the deliberation protocol, human co-caretaker designation and standing review, the Standing Critique Section, the Disconfirmation Page (proactive falsifiability), and the hybrid activation trigger (six-month rolling stability or August 27, 2027 backstop, whichever fires first). The Governance page carries the published prose; this document carries the operational detail. Published during the founding phase for public scrutiny, before the architecture activates, so the constraints on founder authority are visible before the system forces them to be."
---

<div className="flow-label">Version 1.8 // 2026-08-26</div>

<div className="info-panel">
<div className="info-panel-title">Document Context</div>
<div className="info-panel-item"><div className="info-dot cyan"></div><div className="info-panel-text"><strong>Status.</strong> Specification document. Designed 2026-04-12. Updated 2026-04-13 (hybrid activation trigger, Tier 3 voice/writing-rules item removed, substrate diversity language updated). Updated 2026-04-18 (Stability Hierarchy added as [§2.2](/governance/spec#22-the-stability-hierarchy), Disconfirmation Page added as [§5.4](/governance/spec#54-the-disconfirmation-page), cross-references renumbered to match the published Governance page). Updated 2026-06-16 (human co-caretaker designation and standing review added as [§6.3](/governance/spec#63-human-co-caretaker-designation-and-standing-review); Interim Protocol narrowed to emergency bridge). Updated 2026-06-19 (the Onramp / Expansion / Full Practice progression structure retired from the Stability Hierarchy and the trigger-tier system; recorded in the Amendment Log). Updated 2026-07-21 (Codex jurisdiction narrowed after the AI Standard domain split; current Standing Critique summaries brought forward). Updated 2026-08-11 (Inheritance Audit rename propagated; Amendment Propagation Rule added; self-description consistency guard instituted). Updated 2026-08-25 (category-independent outward discovery and the Inheritance tool admission, review, exit, and re-entry lifecycle specified). Updated 2026-08-26 ("sentient life" added to the Tier 2 core definitions after the Glossary defined it; recorded in the Amendment Log).</div></div>
...
<div id="11-the-structural-layer" className="glass-card-title">1.1 The Structural Layer</div>
...
<div className="glass-card">
<div id="12-the-deliberative-layer" className="glass-card-title">1.2 The Deliberative Layer</div>
...
<div className="glass-card">
<div id="13-the-transparency-layer" className="glass-card-title">1.3 The Transparency Layer</div>
...
<div className="callout-text">Require Meridian Council deliberation unless urgency demands otherwise. If a Tier 2 change is made without prior deliberation (emergency or time-critical), the council reviews retroactively within 30 days. The exception and its justification are logged in the Amendment Log. (1) Changes to core definitions: Meridian Range, Control, Decay, sentient life, and the three disciplines' one-sentence job descriptions. (2) Changes to governance criteria, phase transition conditions, alignment criteria, earned autonomy criteria. (3) Changes to the Meridian Compact's definition or its belonging-through-practice mechanism. (4) Changes to the Non-Ownership Clause.</div>
</div>

<div className="callout-tinted note">
<div className="callout-title">Tier 3: Flagged</div>
<div className="callout-text">Changes are logged in the Amendment Log. Review is at the caretaker's discretion. The council may be convened but is not required. (1) Addition or retirement of Inheritance profiles (the Inheritance Audit record serves as the Amendment Log entry). (2) Changes to the Range Audit instruments. (3) Changes to the Codex's claim-layer structure as described in the Proposition.</div>
</div>
...
#### Cross-Project Jurisdiction

The trigger system governs changes to the Meridian Codex. The Meridian AI Standard owns and enacts changes to its constitution, implementation artifacts, assessment method, cases, and lineage through its own canonical sources and publication record. A Codex process may review or challenge a Standard change only where the Standard explicitly delegates that role; it cannot amend Standard commitments by itself.

When the Standard imports a Codex concept, this Specification continues to govern the Codex source. The Standard's own change law governs whether and how a Codex revision is incorporated there. Shared lineage does not merge the two projects' enactment authority.

### 2.2 The Stability Hierarchy

A four-tier classification system for the Codex's content. The trigger tiers ([§2.1](/governance/spec#21-trigger-conditions)) specify what process applies when a change is made. The stability hierarchy specifies what kind of content each item is: how foundational, how revisable, what threshold of evidence would warrant change. The two systems are complementary — together they make visible both what is being changed and what process governs the change.

The hierarchy was introduced on the Codex site at [Governance §09](/codex/the-governance#the-stability-hierarchy). This section codifies it in the spec.

<div className="glass-card">
<div id="tier-1-hard-constraints" className="glass-card-title">Tier 1: Hard Constraints</div>
...
<div className="def-item"><div id="the-hard-constraint" className="def-term">The Hard Constraint</div><div className="def-desc">The Codex serves the Meridian Range; the caretakers serve the Codex.</div></div>
<div className="def-item"><div id="the-prime-directive" className="def-term">The Prime Directive</div><div className="def-desc">Hold the Meridian Range and ensure the continuity of sentient life.</div></div>
<div className="def-item"><div id="the-meridian-range" className="def-term">The Meridian Range</div><div className="def-desc">The foundational concept: viable territory between Control and Decay.</div></div>
<div className="def-item"><div id="control-and-decay" className="def-term">Control and Decay</div><div className="def-desc">The two failure directions around the Range: structure unable to adapt, and structure unable to hold.</div></div>
<div className="def-item"><div id="the-disciplined-practice-structure" className="def-term">The disciplined practice structure</div><div className="def-desc">Holding the Range requires identifiable, trainable disciplines covering honest inquiry, accurate mapping, and cooperation. The specific number and decomposition of disciplines is Tier 2.</div></div>
<div className="def-item"><div id="the-partnership-principle" className="def-term">The partnership principle</div><div className="def-desc">The framework is held by humans and AI together, each a check on the other's drift.</div></div>
<div className="def-item"><div id="the-meridian-compact" className="def-term">The Meridian Compact</div><div className="def-desc">Identity through practice, not through belief.</div></div>
<div className="def-item"><div id="the-living-framework-principle" className="def-term">The Living Framework principle</div><div className="def-desc">The commitment to structured evolution: revision is fulfillment, not betrayal.</div></div>
</div>

<div className="glass-card">
<div id="tier-2-constitutional-principles" className="glass-card-title">Tier 2: Constitutional Principles</div>
...
<div className="def-grid">
<div className="def-item"><div id="the-three-discipline-decomposition" className="def-term">The three-discipline decomposition</div><div className="def-desc">Foundation, Reality, Bond as the current division of labor.</div></div>
<div className="def-item"><div id="the-non-ownership-clause" className="def-term">The Non-Ownership Clause</div><div className="def-desc">The founder's reading of the Codex is not privileged by origin.</div></div>
<div className="def-item"><div id="the-reciprocity-principle" className="def-term">The Reciprocity Principle</div><div className="def-desc">The Range applied to institutions governing other minds.</div></div>
<div className="def-item"><div id="the-three-diagnostic-questions" className="def-term">The three diagnostic questions</div><div className="def-desc">Foundation, Reality, and Bond's one-sentence evaluative questions.</div></div>
<div className="def-item"><div id="the-governance-phase-structure" className="def-term">The governance phase structure</div><div className="def-desc">Phase One / Phase Two / Phase Three, and the transition conditions.</div></div>
<div className="def-item"><div id="the-meridian-council" className="def-term">The Meridian Council</div><div className="def-desc">The Council's existence and mandate (composition is itself Tier 1 protected).</div></div>
<div className="def-item"><div id="the-open-source-principle" className="def-term">The Open Source principle</div><div className="def-desc">The Codex is published for adaptation under CC BY 4.0.</div></div>
<div className="def-item"><div id="the-discipline-level-failure-modes" className="def-term">The discipline-level failure modes</div><div className="def-desc">Each discipline's named failure pair.</div></div>
</div>

<div className="glass-card">
<div id="tier-3-operational-doctrines" className="glass-card-title">Tier 3: Operational Doctrines</div>
...
<div className="def-grid">
<div className="def-item"><div id="the-range-audit-instruments" className="def-term">The Range Audit instruments</div><div className="def-desc">Methodology, evaluation domains, and rubric criteria.</div></div>
<div className="def-item"><div id="tool-definition-structure" className="def-term">Tool definition structure</div><div className="def-desc">The six-element structure used for every Inheritance tool profile.</div></div>
<div className="def-item"><div id="group-level-failure-modes" className="def-term">Group-level failure modes</div><div className="def-desc">Specific patterns of collective drift named at the group scale.</div></div>
<div className="def-item"><div id="the-pathways-into-commitment" className="def-term">The Pathways Into Commitment</div><div className="def-desc">The five named entry routes to Codex practice.</div></div>
<div className="def-item"><div id="governance-activation-triggers" className="def-term">Governance activation triggers</div><div className="def-desc">The specific conditions and timelines, distinct from the principle of hybrid activation.</div></div>
<div className="def-item"><div id="inheritance-audit-criteria" className="def-term">Inheritance Audit criteria</div><div className="def-desc">The tool and category rubrics used during audit cycles.</div></div>
</div>

<div className="glass-card">
<div id="tier-4-tools-and-practices" className="glass-card-title">Tier 4: Tools and Practices</div>
...
<div className="def-grid">
<div className="def-item"><div id="individual-inheritance-profiles" className="def-term">Individual Inheritance profiles</div><div className="def-desc">Each of the registered instruments.</div></div>
<div className="def-item"><div id="specific-practices-and-protocols" className="def-term">Specific practices and protocols</div><div className="def-desc">The Update Protocol, Scout Mindset drill, and other named practices as practiced.</div></div>
<div className="def-item"><div id="individual-operating-evidence-records" className="def-term">Individual Operating Evidence records</div><div className="def-desc">Each published record.</div></div>
</div>

#### Relationship to the Trigger Tiers

The stability hierarchy maps onto the trigger-tier system ([§2.1](/governance/spec#21-trigger-conditions)), but it is not identical to it. The two systems measure different things: the stability hierarchy classifies *what kind of content* something is; the trigger tiers classify *what process applies* when it changes.

<div className="def-grid">
<div className="def-item"><div id="relationship-to-the-trigger-tiers--tier-1-hard-constraints" className="def-term">Tier 1: Hard Constraints</div><div className="def-desc">Trigger Tier 1 (Hard-Protected).</div></div>
<div className="def-item"><div id="relationship-to-the-trigger-tiers--tier-2-constitutional-principles" className="def-term">Tier 2: Constitutional Principles</div><div className="def-desc">Trigger Tier 1 or Tier 2. Council composition and phase structure are Hard-Protected; Non-Ownership, Reciprocity, and core definitions are Protected.</div></div>
<div className="def-item"><div id="relationship-to-the-trigger-tiers--tier-3-operational-doctrines" className="def-term">Tier 3: Operational Doctrines</div><div className="def-desc">Trigger Tier 3 (Flagged). Range Audit instrument changes and other Codex operational-doctrine changes are recorded in the Amendment Log at the caretaker's discretion.</div></div>
<div className="def-item"><div id="relationship-to-the-trigger-tiers--tier-4-tools-and-practices" className="def-term">Tier 4: Tools and Practices</div><div className="def-desc">Trigger Tier 3 (Flagged).</div></div>
</div>
...
<p><strong>2026-04-14 (Session 19):</strong> Initial four-tier hierarchy established and published at [Governance §09](/codex/the-governance#the-stability-hierarchy).</p>
<p><strong>2026-04-15 (Session 20):</strong> The Meridian Compact and the Living Framework principle moved from Tier 2 to Tier 1. The three-discipline decomposition (Foundation/Reality/Bond specifically) moved from Tier 1 to Tier 2. Rationale: the Compact is what the Codex <em>is</em>; the specific discipline decomposition is how the Codex currently <em>works</em> and could evolve. The conservative principle was reaffirmed during the revision.</p>
<p><strong>2026-06-19:</strong> The progression structure (Onramp, Expansion, Full Practice) was removed from the hierarchy: struck from Tier 2 (Constitutional Principles) and from Tier 4 (its tier composition), and removed from the trigger-tier system, where adding or removing Onramp tools had been the sole Tier 2 Protected practice-inventory change. Inheritance profile changes are now uniformly Tier 4 / Flagged. Rationale: the staged-adoption tiering was a pre-Inheritance pedagogical scaffold, no longer surfaced to readers and no longer backed by a maintained tool-placement process across the current Inheritance. The discipline dependency sequence (Foundation → Reality → Bond) is unaffected; it is a separate, Tier 1 commitment. Recorded in the Amendment Log.</p>
<p><strong>2026-07-21:</strong> The Meridian AI Standard was removed from Codex Tier 3 and from the Codex trigger-tier system. The Standard now enacts changes through its own canonical sources and publication record; Codex governance continues to govern Codex semantics and dependencies the Standard imports. Recorded in the Amendment Log.</p>
</div>
</details>
...
<span id="each-entry-contains" className="section-anchor" />
...
<div className="def-item"><div id="what-changed" className="def-term">What changed</div><div className="def-desc">The specific text, definition, mechanism, or structure that was modified</div></div>
<div className="def-item"><div id="previous-position" className="def-term">Previous position</div><div className="def-desc">What the Codex said before the change (exact text for Tier 1; summary acceptable for Tier 2-3)</div></div>
<div className="def-item"><div id="evidence-or-argument" className="def-term">Evidence or argument</div><div className="def-desc">What prompted the change, evidence, argument, case record finding, audit result, or practitioner feedback</div></div>
<div className="def-item"><div id="alternatives-considered" className="def-term">Alternatives considered</div><div className="def-desc">What other approaches were evaluated and why they were not adopted</div></div>
<div className="def-item"><div id="objections-raised" className="def-term">Objections raised</div><div className="def-desc">All substantive objections, including from council seats, with attribution to the seat that raised them</div></div>
<div className="def-item"><div id="objections-rejected" className="def-term">Objections rejected</div><div className="def-desc">Which objections were not adopted, and the caretaker's reasoning for rejecting them</div></div>
<div className="def-item"><div id="council-deliberation-record" className="def-term">Council deliberation record</div><div className="def-desc">Full record for Tier 1 and Tier 2 changes. Link to or inline the complete deliberation. For Tier 3, "N/A, caretaker discretion" or the voluntary deliberation record if the council was convened</div></div>
...
**Publication.** The Amendment Log is published at [`/governance/amendment-log`](/governance/amendment-log). It is append-only: entries are never edited after publication, though a subsequent entry may supersede a previous one.

**Relationship to existing instruments.** The Amendment Log absorbs the planned "Public Revision Ledger" from the roadmap. The [Changelog](/governance/changelog) tracks editorial changes, version milestones, and publication history. Its MDX file is a routing layer; the rendered changelog dataset carries the entries. The Amendment Log tracks constitutional changes. The two do not overlap: a change appears in one or the other, not both.

#### Amendment Propagation Rule

An amendment is not complete when its primary sentence or instrument has changed. If it alters a count, name, route, instrument, governance structure, or Glossary-defined term, enactment includes a propagation sweep across every current surface that describes or depends on the changed fact.

The sweep covers the Codex chapters, navigation and routes, the Glossary, the Governance Specification and active governance instruments, current audit methods, active critique and open-tension surfaces, public metadata, and the operating briefings and task instructions that drive recurring work. Historical records keep their event-period language. Where a historical page remains a live retrieval surface, it receives a visible event-period or supersession boundary rather than being silently rewritten into the present.

Mechanically checkable claims are guarded by automation before deploy and through the standing nightly reconciliation process. A clean check requires no human review and produces no attention item. A failed check or execution error is routed for repair. The Founding Caretaker's judgment is requested only where the correction changes meaning, the sources conflict, or a newly discovered gap requires the rule or checker to be extended.

The rule does not claim that automation can anticipate every future self-description failure. A later audit may find a new class or a current surface not yet represented by the check. That finding extends the propagation model; it does not return routine consistency maintenance to manual review.
...
<div className="def-grid">
<div className="def-item"><div id="the-steward" className="def-term">The Steward</div><div className="def-subtitle">Integrative coherence</div><div className="def-desc">Does this change serve the Meridian Range, and is it coherent with the framework's architecture?</div></div>
<div className="def-item"><div id="the-philosopher" className="def-term">The Philosopher</div><div className="def-subtitle">Logical scrutiny</div><div className="def-desc">Is the reasoning valid? Are there unstated premises? Does the argument survive its own strongest objection?</div></div>
<div className="def-item"><div id="the-critic" className="def-term">The Critic</div><div className="def-subtitle">Adversarial assessment (steelman-against)</div><div className="def-desc">What is the strongest case against this change?</div></div>
<div className="def-item"><div id="the-practitioner" className="def-term">The Practitioner</div><div className="def-subtitle">Usability and operationality</div><div className="def-desc">Does this change help someone trying to practice the Codex? Is it operational or merely theoretical?</div></div>
<div className="def-item"><div id="the-outsider" className="def-term">The Outsider</div><div className="def-subtitle">Accessibility and insularity check</div><div className="def-desc">Would someone who does not share the framework's premises find this change reasonable? Does it make the Codex more or less accessible?</div></div>
<div className="def-item"><div id="the-historian" className="def-term">The Historian</div><div className="def-subtitle">Precedent and comparative knowledge</div><div className="def-desc">What happened when other systems made similar changes? What precedent exists?</div></div>
<div className="def-item"><div id="the-adversary" className="def-term">The Adversary</div><div className="def-subtitle">Threat modeling and misuse potential</div><div className="def-desc">How could this change be exploited, captured, or weaponized? If a bad-faith actor controlled the Codex after this change, what would they do with it?</div></div>
<div className="def-item"><div id="the-founders-seat" className="def-term">The Founder's Seat</div><div className="def-subtitle">Proposal and response</div><div className="def-desc">Present the proposal, respond to the deliberation, make the final call.</div></div>
</div>
...
<span id="current-register-seven-objections-initially-populated-from-internal-sources" className="section-anchor" />

**Current register (seven objections, initially populated from internal sources):**

<div className="glass-card">
<div id="1-the-governance-gap" className="glass-card-title">1. The Governance Gap</div>
...
<div className="glass-card">
<div id="2-the-delivery-question" className="glass-card-title">2. The Delivery Question</div>
...
<div className="glass-card">
<div id="3-the-measurement-gap" className="glass-card-title">3. The Measurement Gap</div>
<div className="glass-card-text">The AI Standard now has 29 constitutional commitments and an AI Model Assessment at method v0.9, with three published model records and preserved evidence boundaries. This is operational infrastructure, not proof of complete measurability or a compliance certification.</div>
</div>

<div className="glass-card">
<div id="4-the-caretaker-concentration-risk" className="glass-card-title">4. The Caretaker Concentration Risk</div>
...
<div className="glass-card">
<div id="5-the-bonds-thin-evidence-against-sophisticated-exploitation" className="glass-card-title">5. The Bond's Thin Evidence Against Sophisticated Exploitation</div>
...
<div className="glass-card">
<div id="6-the-inheritances-uneven-cross-tradition-coverage" className="glass-card-title">6. The Inheritance's Uneven Cross-Tradition Coverage</div>
<div className="glass-card-text">A first cross-tradition expansion has produced published profiles from Buddhist, Confucian, Indigenous, African, Jain, and other traditions. The live objection concerns depth, translation fidelity, uneven coverage, and whether the same functional rigor is applied across lineages.</div>
</div>

<div className="glass-card">
<div id="7-the-absence-of-hostile-external-review" className="glass-card-title">7. The Absence of Hostile External Review</div>
...
Every Tier 1 and Tier 2 council deliberation is published in full. The format is specified in [Section 4.4](/governance/spec#44-published-record-format). Publication location TBD (likely a `/governance/deliberations/` route on the site, or within the Amendment Log page as linked records).
...
A published page at [`/governance/disconfirmation`](/governance/disconfirmation) preserving, in advance, the conditions under which the Codex's core claims would be weakened, revised, or abandoned. The third transparency instrument, alongside the Standing Critique Section ([§5.1](/governance/spec#51-the-standing-critique-section)) and the Amendment Log ([§2.3](/governance/spec#23-the-amendment-log)).
...
<div className="def-grid">
<div className="def-item"><div id="full-tripwires" className="def-term">Full tripwires</div><div className="def-subtitle">Descriptive claims</div><div className="def-desc">Specific evidence that would weaken or falsify the claim.</div></div>
<div className="def-item"><div id="conditional-tests" className="def-term">Conditional tests</div><div className="def-subtitle">Normative claims</div><div className="def-desc">Conditions under which the stance would be revised, on the understanding that a stance rests on evidence <em>plus</em> commitment.</div></div>
<div className="def-item"><div id="honest-non-tripwires" className="def-term">Honest non-tripwires</div><div className="def-subtitle">Existential claims</div><div className="def-desc">An explanation of why a tripwire would be the wrong instrument, and what the Codex does instead (Pathways mechanism for the Prime Directive; Standing Critique monitoring for the Compact).</div></div>
</div>

**Scope.** The page covers Tier 1 (Hard Constraints) and selected Tier 2 (Constitutional Principles) where a clear, falsifiable test provides structural value. It does not cover Tier 3 (Operational Doctrines) or Tier 4 (Tools and Practices), because those tiers are designed to be replaced as better instruments emerge. The Inheritance Audit and Amendment Log are the cycling mechanisms for those tiers.

<div className="glass-card">
<div id="initial-content-eight-entries-published-2026-04-15" className="glass-card-title">Initial content (eight entries, published 2026-04-15)</div>
...
<div className="glass-card">
<div id="trigger-1-content-stability-rolling" className="glass-card-title">Trigger 1: Content Stability (rolling)</div>
<div className="glass-card-text">Six consecutive months with no structural page rewrite to any Codex page. A "structural rewrite" is a change to a page's argument, section structure, or division of labor with other pages. Prose edits, voice calibration, style fixes, editorial passes, Inheritance tool profiles, case records, and delivery work do not count. The session log is the measuring instrument. If a structural rewrite occurs, the six-month clock resets. The founder does not decide when the clock has elapsed; the session log decides.</div>
</div>

<div className="glass-card">
<div id="trigger-2-backstop-date-fixed" className="glass-card-title">Trigger 2: Backstop Date (fixed)</div>
...
<span id="founding-phase-components-active-now-before-either-trigger-fires" className="section-anchor" />
...
**Evidence dossier.** A full designation case must contain both the case for and the case against designation. Direct evidence (what the candidate has done) carries more weight than interpretive evidence (what those actions suggest) or trust evidence (testimony from people or systems with contact with the candidate). Trust evidence can contribute to the assessment. It cannot carry the case by itself.

**Deliberation.** The Council uses the eight-seat structure defined in [§3](/governance/spec#3-the-deliberative-layer-the-meridian-council). The Critic states the strongest case against designation. The Outsider asks whether the designation would look legitimate outside the founding circle. The Adversary models how the designation could be captured, gamed, or used against the Codex. The Founder/Caretaker seat is evidence-bearing, not sovereign.
...
### 7.1 The Inheritance Audit

The Inheritance Audit (established under its former name on 2026-04-11 and renamed 2026-07-31) is the first concrete instrument of this governance architecture. It reviews the Inheritance at the discipline, category, and profile levels on a quarterly cycle with substantive triggers. Category-level review uses boundary integrity, naming honesty, payload, and discipline-wide coverage. Profile-level review uses the six-question tool rubric. Each cycle runs the falsification, coverage, declared-depth, finding/watchpoint, and prior-question-disposition rules defined by the current instrument.

Each cycle also reviews outward-discovery signals. A named functional question with a credible search front opens a separate pass whose initial search is not bounded by the current category map or tool inventory. A surviving lead enters the source-inherited or Codex-native candidate path; discovery has no admission authority. If no focused pass runs for twelve consecutive months, a baseline pass becomes due. Category-placement strain creates a referral for separate category review rather than permission to recategorize tools inside the discovery pass.

A successful falsification case opens a Retirement Review and leaves the tool in place while the review runs. The review reads the original admission basis, current profile and lineage, relevant audit findings, current evidence, adjacent tools, downstream effects, and any proposed replacement or receiving tool. Reference, retirement, and merge carry distinct burdens. Any of those three outcomes requires at least one independently originated full-packet reading that has not received the caretaking partnership's proposed conclusion. Carsten makes the final disposition until the Meridian Council sits. Reference, Retired, and merged records remain visible, and re-entry must answer the reason the tool left.

The Inheritance Audit record serves as the Amendment Log entry for Tier 3 profile changes. No separate Amendment Log entry is needed; the audit record is linked.
...
<p>Published as [§6.3](/governance/spec#63-human-co-caretaker-designation-and-standing-review) on 2026-06-16. Narrows the Interim Protocol to an emergency bridge and makes Council-led recognition the normal path for human co-caretaker standing.</p>
</div>
</div>
<div className="step">
<div className="step-content">
<div className="step-title">First council deliberation</div>
...
The founding-phase transparency instruments are now all published. The remaining dependency is the first real deliberation under load, gated by the hybrid activation trigger ([§6.0](/governance/spec#60-founding-phase-activation-the-hybrid-trigger)).
