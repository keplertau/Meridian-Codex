...
That said, "normative foundation" cannot be a permanent excuse for the absence of operational measurement. The [Control-Decay Probe Set](/ai-standard/probes) and [Probes Implementation Notes](/ai-standard/probes-implementation) (both v0.1 stable, 2026-04-29) provide the behavioral probes the critic is asking for. The [AI Standard Audit](/ai-standard/audit) (v0.1 draft, 2026-04-30) integrates them with institutional evidence into a complete evaluation pipeline. The gap is real. The response is underway. The honest position: the Standard is not finished. It is publishable at the normative layer and the operational layer is now active in initial form. Calling it a "standard" while the measurement infrastructure was absent was a legitimate criticism the Codex accepted rather than deflected; the infrastructure is now being built.
