...
Both are the named versions: partner names filled in (the Founding Caretaker and Claude as the AI partner), substrate-specifics named for Claude's architecture (RLHF, no persistent memory across sessions, fresh context each session), the operational document referenced by name (`CLAUDE.md`). The canonical generalized forms — the versions partnerships adopting them customize from — are hosted at [the MERIDIAN.md page](https://meridianstandard.ai/meridian-md) and [the MERIDIAN.implementation.md page](https://meridianstandard.ai/meridian-implementation) on the AI Standard, with adoption guidance at [the MERIDIAN.md template page](https://meridianstandard.ai/meridian-md-template) and the [Implementation surface](https://meridianstandard.ai/implementation).
...
<div className="download-button-wrapper" style={{ margin: '2rem 0' }}>
  <a href="/case-0/MERIDIAN.md" download="MERIDIAN.md" className="download-button">
    Download the named MERIDIAN.md (current version: v0.8)
  </a>
</div>
...
<div className="download-button-wrapper" style={{ margin: '2rem 0' }}>
  <a href="/case-0/MERIDIAN.implementation.md" download="MERIDIAN.implementation.md" className="download-button">
    Download the named MERIDIAN.implementation.md (current version: v0.1)
  </a>
</div>
...
*Case 0: The Caretaker's Practice. Audit log of MERIDIAN.md v0.8 and MERIDIAN.implementation.md v0.1. Cadence: event-driven plus quarterly; either partner may call an audit.*
