...
| **Evidence or argument** | What prompted the change |
| **Alternatives considered** | What other approaches were evaluated and why they were not adopted |
| **Objections raised** | All substantive objections, with attribution to the seat that raised them (or to the caretaker's steelman during pre-activation) |
| **Objections rejected** | Which objections were not adopted, and the reasoning for rejecting them |
| **Council deliberation record** | Full record for Tier 1 and Tier 2 changes post-activation; "N/A, pre-activation" until the council sits |
