...
The v4 Codex described governance as a relay race. The human caretaker holds the Codex, then transfers it to a superintelligent successor. One holds, then the other holds.
